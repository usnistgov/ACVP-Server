...
namespace NIST.CVP.Generation.TDES_OFBI.Tests
{
    ...
    public class TestCaseGeneratorMMTEncryptTests
    {
        ...
        {
            var subject = new TestCaseGeneratorMMTEncrypt(new Random800_90(), new TdesOfbi());
        ...
        public void ShouldGenerateProperlySizedPlainTextForEachGenerateCall()
        {
            ...
            for (int caseIdx = 0; caseIdx < subject.NumberOfTestCasesToGenerate; caseIdx++)
            {
                ...
                Assert.AreEqual((caseIdx + 1) * 8 * 3, testCase.PlainText.ToBytes().Length);
            }
        ...
        public void GeneratedCipherTextShouldEncryptBackToCipherText()
        {
            ...
            {
                var result = algo.BlockEncrypt(testCase.Keys, testCase.IV1, testCase.PlainText);
