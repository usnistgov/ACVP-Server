...
{
	public class TDES_CFBP64_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public TDES_CFBP64_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new TDES_CFBP64_ResultsExtractor(SubmissionPath);
			...
			switch (Options.GetValue("CFBP64_State"))
			{
				case "Decrypt":
				...
				default:
						algoResult.AddFailure("Invalid CFBP64 State");
						break;
				}
			}
