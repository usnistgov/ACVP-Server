...
{
	public class AES_XPN_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public AES_XPN_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new AES_XPN_ResultsExtractor(SubmissionPath);
