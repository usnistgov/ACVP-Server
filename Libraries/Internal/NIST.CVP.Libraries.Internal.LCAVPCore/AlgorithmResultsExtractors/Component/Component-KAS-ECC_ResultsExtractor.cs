...
{
	public class Component_KAS_ECC_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "800-56a_ECC_SummaryFile.txt";
		private string _summaryFilePath;

		public Component_KAS_ECC_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public Component_KAS_ECC_Results Extract()
		{
			Component_KAS_ECC_Results results = new Component_KAS_ECC_Results();
