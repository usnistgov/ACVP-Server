...
{
	public class SHA3_512_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "SHA3_Summary.txt";
		private string _summaryFilePath;

		public SHA3_512_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public SHA3_512_Results Extract()
		{
			SHA3_512_Results results = new SHA3_512_Results();
			...
			string passLineValue = ParsingHelper.GetValueStringFromSummaryLinesByKey(lines, "[SHA3_512]");
