...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.KDF
{
	public class KDF : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KDF
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KDF.Capability
			{
				KDFMode = x.Mode,
				MacMode = x.MACModes,
