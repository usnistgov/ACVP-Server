...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.KAS
{
	public class KAS_FFC : AlgorithmBase, IAlgorithm
	{
		...
		public class SchemeCollection
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeCollection ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeCollection
			{
		...
		public abstract class SchemeBase
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeKC ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeKC
			{
				Role = Role,
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeNoKC ToPersistedNoKC() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeNoKC
			{
				Role = Role,
				KdfNoKc = KdfNoKc?.ToPersisted(),
			};

			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeDhStatic ToPersistedDhStatic() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.SchemeDhStatic
			{
				Role = Role,
		...
		public class KdfNoKc : NoKdfNoKc
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfNoKc ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfNoKc
			{
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted()
			};

			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfNoKcDhStatic ToPersistedDhStatic() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfNoKcDhStatic
			{
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted(),
		...
		public class KdfKc : KdfNoKc
		{
			...
			public new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfKc ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfKc
			{
			...
			public new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfKcDhStatic ToPersistedDhStatic() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfKcDhStatic
			{
				KcOption = KcOption?.ToPersisted(),
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted(),
		...
		public class ParameterSets
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSets ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSets
			{
		...
		public class ParameterSet
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSetFB ToPersistedParameterSetFB() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSetFB
			{
				HashAlg = HashAlg,
				MacOption = MacOption?.ToPersistedMacOptionsFB()
			};

			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSetFC ToPersistedParameterSetFC() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.ParameterSetFC
			{
				HashAlg = HashAlg,
		...
		public class KdfOptions
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfOptions ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KdfOptions
			{
		...
		public class MacOptions
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionsFB ToPersistedMacOptionsFB() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionsFB
			{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionsFC ToPersistedMacOptionsFC() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionsFC
			{
				AesCcm = AesCcm?.ToPersistedMacOptionWithNonceLen(),
				Cmac = Cmac?.ToPersistedMacOption(),
				HmacSha2_D256 = HmacSha2_D256?.ToPersistedMacOption(),
		...
		public class MacOptionsBase
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOption ToPersistedMacOption() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOption
			{
				KeyLen = KeyLen.ToCoreDomain(),
				MacLen = MacLen
			};

			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionWithNonceLen ToPersistedMacOptionWithNonceLen() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.MacOptionWithNonceLen
			{
				KeyLen = KeyLen.ToCoreDomain(),
				MacLen = MacLen,
				NonceLen = NonceLen
		...
		public class KcOptions
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KcOptions ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC.KcOptions
			{
				KcRole = KcRole,
				KcType = KcType,
				NonceType = NonceType
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_FFC
		{
			Functions = Functions,
