...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_CMAC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.TDES_CMAC
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.TDES_CMAC.CapabilityObject
			{
