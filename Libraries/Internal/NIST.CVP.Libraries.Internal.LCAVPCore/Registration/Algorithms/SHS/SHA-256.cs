...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.SHS
{
	public class SHA_256 : AlgorithmBase, IAlgorithm
	{
		...
		public SHA_256(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "SHA2-256")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.SHA2_256
		{
