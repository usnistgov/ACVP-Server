...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.SHS
{
	public class SHA_512 : AlgorithmBase, IAlgorithm
	{
		...
		public SHA_512(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "SHA2-512")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.SHA2_512
		{
