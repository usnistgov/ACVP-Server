...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.SHS
{
	public class SHA_224 : AlgorithmBase, IAlgorithm
	{
		...
		public SHA_224(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "SHA2-224")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.SHA2_224
		{
