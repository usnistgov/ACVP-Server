...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.KAS
{
	public class Component_KAS_ECC : AlgorithmBase, IAlgorithm
	{
		...
		public class SchemeCollection
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.SchemeCollection ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.SchemeCollection
			{
		...
		public abstract class SchemeBase
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.Scheme ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.Scheme
			{
				Role = Role,
		...
		public class NoKdfNoKc
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.NoKdfNoKc ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.NoKdfNoKc
			{
		...
		public class ParameterSets
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.ParameterSets ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.ParameterSets
			{
				EB = EB?.ToPersisted(),
				EC = EC?.ToPersisted(),
				ED = ED?.ToPersisted(),
		...
		public class ParameterSet
		{
			...
			public NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.ParameterSet ToPersisted() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component.ParameterSet
			{
				Curve = Curve,
				HashAlg = HashAlg
			};
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.KAS_ECC_Component
		{
			Functions = Functions,
