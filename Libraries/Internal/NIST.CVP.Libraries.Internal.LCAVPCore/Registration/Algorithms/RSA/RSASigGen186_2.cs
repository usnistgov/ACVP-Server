...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.RSA
{
	public class RSASigGen186_2 : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.RSASigGen186_2
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.RSASigGen186_2.Capability
			{
