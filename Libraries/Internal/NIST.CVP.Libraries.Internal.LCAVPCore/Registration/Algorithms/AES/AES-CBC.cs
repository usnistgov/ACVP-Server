...
using NIST.CVP.Libraries.Internal.LCAVPCore.CustomValidators;
...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.AES
{
	public class AES_CBC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.AES_CBC
		{
			Direction = Direction,
			KeyLength = KeyLen
		};
