...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.HMAC
{
	public class HMAC_SHA3_256 : AlgorithmBase, IAlgorithm
	{
		...
		public HMAC_SHA3_256(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "HMAC-SHA3-256")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.HMAC_SHA3_256
		{
