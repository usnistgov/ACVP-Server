...
{
	public class HMAC_SHA3_512 : AlgorithmBase, IAlgorithm
	{
		...
		public HMAC_SHA3_512(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "HMAC-SHA3-512")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.HMAC_SHA3_512
		{
