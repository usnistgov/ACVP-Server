...
{
	public class HMAC_SHA2_256 : AlgorithmBase, IAlgorithm
	{
		...
		public HMAC_SHA2_256(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "HMAC-SHA2-256")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.HMAC_SHA2_256
		{
