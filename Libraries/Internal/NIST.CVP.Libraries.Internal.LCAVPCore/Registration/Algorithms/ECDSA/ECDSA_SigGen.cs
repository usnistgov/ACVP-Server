...
using NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.ECDSA.Capabilities;

namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.ECDSA
{
	public class ECDSA_SigGen : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.ECDSASigGen186_4
		{
			ComponentTest = false,
