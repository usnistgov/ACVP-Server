...
namespace NIST.CVP.Libraries.Internal.LCAVPCore.Registration.Algorithms.SHA_3
{
	public class SHA3_224 : AlgorithmBase, IAlgorithm
	{
		...
		public SHA3_224(Dictionary<string, string> options, IDataProvider dataProvider) : base(dataProvider, "SHA3-224")
		{
			if (options.GetValue("SHA3_NoNull") == "False") IncludeNull = true;
			if (options.GetValue("SHA3_224_Byte") == "False") BitOrientedInput = true;
		}

		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Libraries.Internal.Algorithms.Persisted.SHA3_224
		{
