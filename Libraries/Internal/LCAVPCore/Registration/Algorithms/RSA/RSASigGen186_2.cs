...
namespace LCAVPCore.Registration.Algorithms.RSA
{
	public class RSASigGen186_2 : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Algorithms.Persisted.RSASigGen186_2
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Algorithms.Persisted.RSASigGen186_2.Capability
			{
