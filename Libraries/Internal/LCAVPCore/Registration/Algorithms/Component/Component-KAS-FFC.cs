...
namespace LCAVPCore.Registration.Algorithms.Component
{
	public class Component_KAS_FFC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component
		{
			Functions = Functions,
	...
	public class Schemes
	{
		...
		public NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.SchemeCollection ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.SchemeCollection
		{
	...
	public abstract class Scheme
	{
		...
		public NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.Scheme ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.Scheme
		{
			Role = Role,
	...
	public class NoKdfNoKc
	{
		...
		public NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.NoKdfNoKc ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.NoKdfNoKc
		{
	...
	public class ParameterSets
	{
		...
		public NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.ParameterSets ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.ParameterSets
		{
			FB = Fb?.ToPersisted(),
			FC = Fc?.ToPersisted()
		};
	...
	public class ParameterSet
	{
		...
		public NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.ParameterSet ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_FFC_Component.ParameterSet
		{
			HashAlg = HashAlg
		};
	}
