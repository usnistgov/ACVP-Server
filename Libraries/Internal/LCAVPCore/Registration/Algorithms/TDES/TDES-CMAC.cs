...
namespace LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_CMAC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Algorithms.Persisted.TDES_CMAC
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Algorithms.Persisted.TDES_CMAC.CapabilityObject
			{
