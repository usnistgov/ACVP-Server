...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_CMAC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Algorithms.Persisted.AES_CMAC
		{
			Capabilities = Capabilities.Select(x => new NIST.CVP.Algorithms.Persisted.AES_CMAC.Capability
			{
