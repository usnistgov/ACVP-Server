...
namespace LCAVPCore.Registration.Algorithms.KAS
{
	public class KAS_ECC : AlgorithmBase, IAlgorithm
	{
		...
		public class SchemeCollection
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeCollection ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeCollection
			{
		...
		public abstract class SchemeBase
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.Scheme ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.Scheme
			{
				Role = Role,
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeEphemeralUnified ToPersistedEphemeralUnified() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeEphemeralUnified
			{
				Role = Role,
				KdfNoKc = KdfNoKc?.ToPersisted()
			};

			public NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeStaticUnified ToPersistedStaticUnified() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.SchemeStaticUnified
			{
				Role = Role,
		...
		public class KdfNoKc : NoKdfNoKc
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfNoKc ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfNoKc
			{
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted()
			};

			public NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfNoKcStaticUnified ToPersistedStaticUnified() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfNoKcStaticUnified
			{
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted(),
		...
		public class KdfKc : KdfNoKc
		{
			...
			public new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfKc ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfKc
			{
			...
			public new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfKcStaticUnified ToPersistedStaticUnified() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfKcStaticUnified
			{
				KcOption = KcOption?.ToPersisted(),
				KdfOption = KdfOption?.ToPersisted(),
				ParameterSets = ParameterSets?.ToPersisted(),
		...
		public class ParameterSets
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSets ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSets
			{
		...
		public class ParameterSetBase
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEB ToPersistedParameterSetEB() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEB
			{
				Curve = Curve,
				HashAlg = HashAlg,
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEC ToPersistedParameterSetEC() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEC
			{
				Curve = Curve,
				HashAlg = HashAlg,
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetED ToPersistedParameterSetED() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetED
			{
				Curve = Curve,
				HashAlg = HashAlg,
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEE ToPersistedParameterSetEE() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.ParameterSetEE
			{
				Curve = Curve,
				HashAlg = HashAlg,
		...
		public class KdfOptions
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfOptions ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KdfOptions
			{
		...
		public class MacOptions
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEB ToPersistedMacOptionsEB() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEB
			{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEC ToPersistedMacOptionsEC() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEC
			{
				AesCcm = AesCcm?.ToPersistedMacOptionWithNonceLen(),
				Cmac = Cmac?.ToPersistedMacOption(),
				HmacSha2_D256 = HmacSha2_D256?.ToPersistedMacOption(),
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsED ToPersistedMacOptionsED() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsED
			{
				AesCcm = AesCcm?.ToPersistedMacOptionWithNonceLen(),
				Cmac = Cmac?.ToPersistedMacOption(),
				HmacSha2_D384 = HmacSha2_D384?.ToPersistedMacOption(),
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEE ToPersistedMacOptionsEE() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionsEE
			{
				AesCcm = AesCcm?.ToPersistedMacOptionWithNonceLen(),
				Cmac = Cmac?.ToPersistedMacOption(),
				HmacSha2_D512 = HmacSha2_D512?.ToPersistedMacOption()
		...
		public class MacOptionsBase
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOption ToPersistedMacOption() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOption
			{
				KeyLen = KeyLen.ToCoreDomain(),
				MacLen = MacLen
			};

			public NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionWithNonceLen ToPersistedMacOptionWithNonceLen() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.MacOptionWithNonceLen
			{
				KeyLen = KeyLen.ToCoreDomain(),
				MacLen = MacLen,
				NonceLen = NonceLen
		...
		public class KcOptions
		{
			...
			public NIST.CVP.Algorithms.Persisted.KAS_ECC.KcOptions ToPersisted() => new NIST.CVP.Algorithms.Persisted.KAS_ECC.KcOptions
			{
				KcRole = KcRole,
				KcType = KcType,
				NonceType = NonceType
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new NIST.CVP.Algorithms.Persisted.KAS_ECC
		{
			Functions = Functions,
