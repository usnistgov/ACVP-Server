...
{
	public class AES_GCM_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public AES_GCM_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new AES_GCM_ResultsExtractor(SubmissionPath);
