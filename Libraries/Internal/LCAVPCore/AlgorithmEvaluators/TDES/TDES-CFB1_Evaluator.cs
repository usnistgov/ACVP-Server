...
{
	public class TDES_CFB1_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public TDES_CFB1_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new TDES_CFB1_ResultsExtractor(SubmissionPath);
			...
			else
			{
				...
				switch (Options.GetValue("CFB1_State"))
				{
					case "Decrypt":
					...
					default:
						algoResult.AddFailure("Invalid CFB1 State");
						break;
				}
			}
