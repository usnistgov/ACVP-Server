...
using LCAVPCore.AlgorithmResults.KAS;

namespace LCAVPCore.AlgorithmResultsExtractors.KAS
{
	public class KAS_FFC_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "800-56a_FFC_SummaryFile.txt";
		private string _summaryFilePath;

		public KAS_FFC_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public KAS_FFC_Results Extract()
		{
			KAS_FFC_Results results = new KAS_FFC_Results();
