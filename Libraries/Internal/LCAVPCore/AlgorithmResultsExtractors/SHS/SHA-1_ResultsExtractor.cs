...
{
	public class SHA_1_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "SHA_Summary.txt";
		private string _summaryFilePath;

		public SHA_1_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public SHA_1_Results Extract()
		{
			SHA_1_Results results = new SHA_1_Results();
			...
			string passLineValue = ParsingHelper.GetValueStringFromSummaryLinesByKey(lines, "[SHA-1]");
