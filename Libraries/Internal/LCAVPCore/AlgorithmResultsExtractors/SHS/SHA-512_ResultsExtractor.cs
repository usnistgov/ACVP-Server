...
{
	public class SHA_512_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "SHA_Summary.txt";
		private string _summaryFilePath;

		public SHA_512_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public SHA_512_Results Extract()
		{
			SHA_512_Results results = new SHA_512_Results();
			...
			string passLineValue = ParsingHelper.GetValueStringFromSummaryLinesByKey(lines, "[SHA-512]");
