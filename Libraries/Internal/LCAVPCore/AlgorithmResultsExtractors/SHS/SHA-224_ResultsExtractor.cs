...
{
	public class SHA_224_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "SHA_Summary.txt";
		private string _summaryFilePath;

		public SHA_224_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public SHA_224_Results Extract()
		{
			SHA_224_Results results = new SHA_224_Results();
			...
			string passLineValue = ParsingHelper.GetValueStringFromSummaryLinesByKey(lines, "[SHA-224]");
