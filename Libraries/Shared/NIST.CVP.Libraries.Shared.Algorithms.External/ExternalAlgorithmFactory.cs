	...
	public static class ExternalAlgorithmFactory
	{
		public static IExternalAlgorithm Deserialize(string algorithmRegistration)
		{
			...
			return (algorithmBase.Name, algorithmBase.Mode, algorithmBase.Revision) switch
			{
				...
				("ACVP-AES-FF3-1", null, "1.0") => JsonSerializer.Deserialize<AES_FF3_1>(algorithmRegistration),
				("ACVP-AES-GCM", null, "1.0") => JsonSerializer.Deserialize<AES_GCM>(algorithmRegistration),
				("ACVP-AES-GCM-SIV", null, "1.0") => JsonSerializer.Deserialize<AES_GCM_SIV>(algorithmRegistration),
				...
				("DetECDSA", "sigGen", "FIPS186-5") => JsonSerializer.Deserialize<DeterministicECDSASigGen186_5>(algorithmRegistration),
				...
				("ECDSA", "keyGen", "FIPS186-5") => JsonSerializer.Deserialize<ECDSAKeyGen186_5>(algorithmRegistration),
				("ECDSA", "keyVer", "1.0") => JsonSerializer.Deserialize<ECDSAKeyVer186_4>(algorithmRegistration),
				("ECDSA", "keyVer", "FIPS186-5") => JsonSerializer.Deserialize<ECDSAKeyVer186_5>(algorithmRegistration),
				("ECDSA", "sigGen", "1.0") => JsonSerializer.Deserialize<ECDSASigGen186_4>(algorithmRegistration),
				("ECDSA", "sigGen", "FIPS186-5") => JsonSerializer.Deserialize<ECDSASigGen186_5>(algorithmRegistration),
				("ECDSA", "sigVer", "1.0") => JsonSerializer.Deserialize<ECDSASigVer186_4>(algorithmRegistration),
				("ECDSA", "sigVer", "FIPS186-5") => JsonSerializer.Deserialize<ECDSASigVer186_5>(algorithmRegistration),
				("EDDSA", "keyGen", "1.0") => JsonSerializer.Deserialize<EDDSAKeyGen>(algorithmRegistration),
				...
				("KAS-ECC-SSC", null, "Sp800-56Ar3") => JsonSerializer.Deserialize<KAS_ECC_SSC_SP800_56Ar3>(algorithmRegistration),
				...
				("kdf-components", "pbkdf", "1.0") => JsonSerializer.Deserialize<PBKDF>(algorithmRegistration),
				...
				("KTS-IFC", null, "Sp800-56Br2") => JsonSerializer.Deserialize<KTS_IFC>(algorithmRegistration),
				...
				("RSA", "keyGen", "FIPS186-5") => JsonSerializer.Deserialize<RSAKeyGen186_5>(algorithmRegistration),
				("RSA", "sigGen", "1.0") => JsonSerializer.Deserialize<RSASigGen186_4>(algorithmRegistration),
				("RSA", "sigGen", "FIPS186-5") => JsonSerializer.Deserialize<RSASigGen186_5>(algorithmRegistration),
				("RSA", "sigVer", "1.0") => JsonSerializer.Deserialize<RSASigVer186_4>(algorithmRegistration),
				("RSA", "sigVer", "FIPS186-5") => JsonSerializer.Deserialize<RSASigVer186_5>(algorithmRegistration),
				...
				("SHA2-512/224", null, "1.0") => JsonSerializer.Deserialize<SHA2_512224>(algorithmRegistration),
				("SHA2-512/256", null, "1.0") => JsonSerializer.Deserialize<SHA2_512256>(algorithmRegistration),
