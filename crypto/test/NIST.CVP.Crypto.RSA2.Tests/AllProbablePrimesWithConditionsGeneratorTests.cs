...
namespace NIST.CVP.Crypto.RSA2.Tests
{
    ...
    public class AllProbablePrimesWithConditionsGeneratorTests
    {
        ...
        [TestCase(2048, 200, 176, 352, 144, "0100000001",       // Line 31391
            ...
            TestName = "ShouldCorrectlyGeneratePrimes - AllProbablePrimesWithConditionsGenerator - 2048, 200, 176, 352, 144"
        )]
        [TestCase(2048, 216, 144, 280, 176, "0100000001",
            ...
            TestName = "ShouldCorrectlyGeneratePrimes - AllProbablePrimesWithConditionsGenerator - 2048, 216, 144, 280, 176"
        )]
        [TestCase(3072, 528, 208, 544, 192, "0100000001",
            ...
            TestName = "ShouldCorrectlyGeneratePrimes - AllProbablePrimesWithConditionsGenerator - 3072, 528, 208, 544, 192"
        )]
        [TestCase(3072, 456, 176, 384, 360, "957a31",
            ...
            TestName = "ShouldCorrectlyGeneratePrimes - AllProbablePrimesWithConditionsGenerator - 3072, 456, 176, 384, 360"
        )]
