...
namespace NIST.CVP.Crypto.Math.Tests
{
    ...
    public class PrimeGen186_4Tests
    {
        ...
        [TestCase("00c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62cf7e", 392,
            ...
            Common.Hash.SHA2.ModeValues.SHA2, Common.Hash.SHA2.DigestSizes.d256
        )]
        ...
        [TestCase("cad20639f564334910aed056da3b56f4253c5150632627f8d4f5b8803e941f4d", 440,
            ...
            Common.Hash.SHA2.ModeValues.SHA2, Common.Hash.SHA2.DigestSizes.d512
        )]
        public void ShouldFullShaweTaylorCorrectly(string seedHex, int len, string primeHex, string primeSeedHex, Common.Hash.SHA2.ModeValues mode, Common.Hash.SHA2.DigestSizes dig)
        {
        ...
        [TestCase("00c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62cf7e", 392,
            "de6453afdc2a7bad4c4199d20b928b4898db10716480fedf1e994425949fa3d7ca0fcee5064597b119c8faf50858cf33fb",
            "c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62d0b5",
            Common.Hash.ShaWrapper.ModeValues.SHA2, Common.Hash.ShaWrapper.DigestSizes.d256
        )]
        [TestCase("00c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62cf7e", 27,
            "06a77c79",
            "c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62cfb8",
        ...
        [TestCase("cad20639f564334910aed056da3b56f4253c5150632627f8d4f5b8803e941f4d", 440,
            "00b6fe6c2a9cc304ee8fed70909b7d999b8b5d9966997d9b6db637fb0cdf876454d773264e455af3de97b9d058e718876d87808d6b7057dd",
            "cad20639f564334910aed056da3b56f4253c5150632627f8d4f5b8803e941fd0",
            Common.Hash.ShaWrapper.ModeValues.SHA2, Common.Hash.ShaWrapper.DigestSizes.d512
        )]
        public void ShouldFullShaweTaylorCorrectlyWithShaWrapper(string seedHex, int len, string primeHex, string primeSeedHex, Common.Hash.ShaWrapper.ModeValues mode, Common.Hash.ShaWrapper.DigestSizes dig)
        {
            var shaFactory = new ShaFactory();
            var hf = new Common.Hash.ShaWrapper.HashFunction(mode, dig);
            var sha = shaFactory.GetShaInstance(hf);
            var seed = new BitString(seedHex).ToPositiveBigInteger();
        ...
        [TestCase(18, "4ab3e23a488eae6d0fe5f2c284a7ec6ca5a9366f815527e6e2e0f5ad", "00038e9d")]
        [TestCase(18, "32d0f92233675392519e0b9650e42721a3dc740caacc0d1fb6a83429", "0003c5a1")]
        public void ShouldShortShaweTaylorCorrectlyWithShaWrapper(int len, string seedHex, string primeHex)
        {
            var shaFactory = new ShaFactory();
            var hf = new Common.Hash.ShaWrapper.HashFunction(Common.Hash.ShaWrapper.ModeValues.SHA1, Common.Hash.ShaWrapper.DigestSizes.d160);
            var sha = shaFactory.GetShaInstance(hf);
            var seed = new BitString(seedHex).ToPositiveBigInteger();
        ...
        [Test]
        [TestCase("b24d92a1d4a8c5cefd8e93e2db24936262259c8cac122325e28f0850", "cdb2685d10b535aead5b8f29f2b13ef59ea9f1e5", Common.Hash.SHA2.ModeValues.SHA1, Common.Hash.SHA2.DigestSizes.d160)]
        [TestCase("00c43e35054d734394b4448eeaeb8724173aa0955357af8545ce24411f62cf7e", "3C51747150C2B0C33CD4C1B63F9E5608F0B8A2CCC88A0051BF6BA914C9B2D8B8", Common.Hash.SHA2.ModeValues.SHA2, Common.Hash.SHA2.DigestSizes.d256)]
        public void SmallHashTest(string primeSeedHex, string expectedHex, Common.Hash.SHA2.ModeValues mode, Common.Hash.SHA2.DigestSizes dig)
        {
            var hf = new Common.Hash.SHA2.HashFunction { Mode = mode, DigestSize = dig };
            var primeSeed = new BitString(primeSeedHex).ToPositiveBigInteger();
