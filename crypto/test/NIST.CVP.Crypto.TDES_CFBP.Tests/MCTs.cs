...
namespace NIST.CVP.Crypto.TDES_CFBP.Tests
{
    ...
    public class MCTs
    {
        ...
        {
            public TestCFBPModeMCT(IMonteCarloKeyMaker keyMaker, IModeOfOperation modeOfOperation, Algo algo)
            ...
            Algo algo, bool isPtAndCtHex = true)
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.AreEqual(expectedFinalIV1.ToHex(), result.Response[result.Response.Count - 1].IV.ToHex(), nameof(expectedIv1));
...
//        private class TestTDesCfbMct : TDES_CFB_MCT
//        {
//            public TestTDesCfbMct(IMonteCarloKeyMaker keyMaker, IModeOfOperation modeOfOperation)
//                : base(keyMaker, modeOfOperation) { }
...
//        {
//            var mode = ModeFactory.GetMode(algo);
//            TestTDesCfbMct _subject = new TestTDesCfbMct(new MonteCarloKeyMaker(), mode);
