...
namespace NIST.CVP.Crypto.RSA.Tests.PrimeGenerators
{
    ...
    public class ProvableProbablePrimesWithConditionsGeneratorTests
    {
        ...
        public void ShouldSTCorrectly(string seedHex, int len, string primeHex, string primeSeedHex)
        {
            var subject = new ProvableProbablePrimesWithConditionsGenerator(new HashFunction { Mode = ModeValues.SHA2, DigestSize = DigestSizes.d256 }, EntropyProviderTypes.Testable);
