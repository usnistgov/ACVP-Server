...
namespace NIST.CVP.Crypto.RSA.Tests.PrimeGenerators
{
    ...
    public class AllProvablePrimesWithConditionsGeneratorTests
    {
        ...
        public void ShouldFailWithBadParameters(int nlen, string e, string seed)
        {
            ...
            var subject = new AllProvablePrimesWithConditionsGenerator(hashFunction);
        ...
        {
            var subject = new AllProvablePrimesWithConditionsGenerator(new HashFunction {Mode = mode, DigestSize = dig});
