...
namespace NIST.CVP.Crypto.RSA.Tests.PrimeGenerators
{
    ...
    public class AllProbablePrimesWithConditionsGeneratorTests
    {
        ...
        [Test]
        [TestCase(2048, 200, 173, 352, 141, "0100000001",
        ...
        [TestCase(2048, 216, 142, 280, 170, "0100000001",
        ...
        [TestCase(3072, 528, 207, 544, 190, "0100000001",
        ...
        [TestCase(3072, 456, 175, 384, 358, "957a31",
