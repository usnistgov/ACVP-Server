...
{
    public class SHA512t256Properties : SHAPropertiesBase
    {
        ...
        public override string[] HValues => new [] { "22312194FC2BF72C", "9F555FA3C84C64C2", "2393B86B6F53B151", "963877195940EABD",
