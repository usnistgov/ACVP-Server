...
namespace NIST.CVP.Generation.DSA.FFC.KeyGen.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            return new ParseResponse<TestVectorSet>(new TestVectorSet { Algorithm = "DSA", Mode = "KeyGen", TestGroups = groups.Select(g => (ITestGroup)g).ToList() });
        }
    }
}
