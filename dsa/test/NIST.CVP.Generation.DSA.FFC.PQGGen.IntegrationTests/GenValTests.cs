...
namespace NIST.CVP.Generation.DSA.FFC.PQGGen.IntegrationTests
{
    ...
    public class GenValTests
    {
        ...
        public void SetUp()
        {
            ...
            DSA_PQGGen_Val.AutofacConfig.OverrideRegistrations = null;
        }
        ...
        {
            DSA_PQGGen_Val.AutofacConfig.OverrideRegistrations = builder =>
            {
            ...
            var result = DSA_PQGGen_Val.Program.Main(
        ...
        private string GetTestFolder(string name = "")
        {
            ...
            var folderName = "PQGGen--" + prefix + Guid.NewGuid().ToString().Substring(0, 8);
