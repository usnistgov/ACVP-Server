...
namespace NIST.CVP.Generation.KeyWrap.Tests.TDES
{
    ...
    public class TestCaseGeneratorFactoryFactoryTests
    {
        ...
        private TestCaseGeneratorFactoryFactory<TestVectorSet, TestGroup, TestCase> _subject;
        ...
        public void Setup()
        {
            ...
            _subject = new TestCaseGeneratorFactoryFactory<TestVectorSet, TestGroup, TestCase>(_testCaseGeneratorFactory.Object);
        ...
        public void ShouldReturnErrorMessageWithinGenerateResponseWhenFails()
        {
            _testCaseGeneratorFactory
                ...
                .Returns(new TestCaseGeneratorNull<TestGroup, TestCase>());
