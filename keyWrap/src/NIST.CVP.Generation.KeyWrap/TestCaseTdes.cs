...
{
    public class TestCaseTdes : ITestCase
    {
        ...
        public TestCaseTdes(dynamic source)
        {
            MapToProperties(source);
        }

        public TestCaseTdes(string key, string plainText, string cipherText)
        {
        ...
        public TestCaseTdes(JObject source)
        {
        ...
        public bool Merge(ITestCase otherTest)
        {
            ...
            var otherTypedTest = (TestCaseTdes)otherTest;
