...
{
    public class TestGroupTdes : ITestGroup
    {
        ...
        public int KeyLength => 192;

        [JsonProperty(PropertyName = "ptLen")]
        public int PtLen { get; set; }

        public KeyWrapType KeyWrapType => KeyWrapType.TDES_KW;
        ...
        public TestGroupTdes()
        {
            Tests = new List<ITestCase>();
        }

        public TestGroupTdes(dynamic source)
        {
            ...
            {
                Tests.Add(new TestCaseTdes(test));
            }
        ...
        {
            var otherGroup = obj as TestGroupTdes;
            if (otherGroup == null)
            {
                return false;
            }
