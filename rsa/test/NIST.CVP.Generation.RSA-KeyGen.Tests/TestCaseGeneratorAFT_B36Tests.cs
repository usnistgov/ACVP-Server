...
namespace NIST.CVP.Generation.RSA_KeyGen.Tests
{
    ...
    public class TestCaseGeneratorAFT_B36Tests
    {
        [Test]
        [TestCase(true)]
        [TestCase(false)]
        ...
        public void GenerateShouldInvokeKeyGenOperation()
        {
            ...
            keyGen
                .Setup(s => s.GeneratePrimes(It.IsAny<int>(), It.IsAny<BigInteger>(), It.IsAny<BitString>()))
                .Returns(new PrimeGeneratorResult(0, 0, new AuxiliaryPrimeGeneratorResult(1, 2, 3, 4, 5, 6)));
            ...
            var subject = new TestCaseGeneratorAFT_B36(rand.Object, keyGen.Object);
        ...
        {
            var subject = new TestCaseGeneratorAFT_B36(new Random800_90(), new AllProbablePrimesWithConditionsGenerator());
        ...
        public void DeferredTestCaseShouldBeCompleted()
        {
            ...
            keyGen
                .Setup(s => s.GeneratePrimes(It.IsAny<int>(), It.IsAny<BigInteger>(), It.IsAny<BitString>()))
                .Returns(new PrimeGeneratorResult(31, 43, new AuxiliaryPrimeGeneratorResult(1, 2, 3, 4, 5, 6)));
        ...
        private Mock<AllProbablePrimesWithConditionsGenerator> GetPrimeGenMock()
        {
            return new Mock<AllProbablePrimesWithConditionsGenerator>();
        }
