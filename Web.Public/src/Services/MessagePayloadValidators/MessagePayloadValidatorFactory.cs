...
{
	public class MessagePayloadValidatorFactory : IMessagePayloadValidatorFactory
	{
		...
		public IMessagePayloadValidator GetMessagePayloadValidator(APIAction action)
		{
			return action switch
			{
				...
				APIAction.CreatePerson => new PersonCreatePayloadValidator(_organizationService),
				APIAction.CreateVendor => new OrganizationCreatePayloadValidator(_organizationService),
				...
				APIAction.DeletePerson => new PersonDeletePayloadValidator(_personService),
				APIAction.DeleteVendor => new OrganizationDeletePayloadValidator(_organizationService),
				...
				APIAction.UpdateOE => new OperatingEnvironmentUpdatePayloadValidator(this, _oeService, _dependencyService),
