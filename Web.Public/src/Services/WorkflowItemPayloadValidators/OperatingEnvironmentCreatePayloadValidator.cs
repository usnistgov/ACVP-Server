...
{
	public class OperatingEnvironmentCreatePayloadValidator : IWorkflowItemValidator
	{
		private readonly IWorkflowItemValidatorFactory _workflowItemValidatorFactory;
		private readonly IDependencyService _dependencyService;

		public OperatingEnvironmentCreatePayloadValidator(IWorkflowItemValidatorFactory workflowItemValidatorFactory, IDependencyService dependencyService)
		{
