...
namespace NIST.CVP.Generation.AES_OFB.IntegrationTests
{
    ...
    public class GenValTests : GenValTestsBase
    {
        ...
        public override Executable Validator => AES_OFB_Val.Program.Main;

        [SetUp]
        public override void SetUp()
        {
            AutofacConfig.OverrideRegistrations = null;
            AES_OFB_Val.AutofacConfig.OverrideRegistrations = null;
        }
        ...
        {
            AES_OFB_Val.AutofacConfig.OverrideRegistrations = builder =>
            {
