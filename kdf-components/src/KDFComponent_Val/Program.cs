...
namespace KDFComponent_Val
{
    public class Program
    {
        public static int Main(string[] args)
        {
            if (args.Length < 4)
            {
                Console.Error.WriteLine("Not enough arguments supplied, must supply paths for result, prompt and and answer files, and algo");
                return 1;
            }
            var algo = args[0];
            ...
            LoggingHelper.ConfigureLogging(resultFile, "kdf-components-val");
        ...
        private static Logger Logger => LogManager.GetLogger("Validate");
    }
}
