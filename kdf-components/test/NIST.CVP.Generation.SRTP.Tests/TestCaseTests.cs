...
namespace NIST.CVP.Generation.SRTP.Tests
{
    ...
    public class TestCaseTests
    {
        ...
        public void ShouldReconstituteTestCaseFromProperJObject()
        {
            ...
            sourceTest.Add("srtpKs", new JValue("00AA"));
            var subject = new TestCase(sourceTest);
            Assert.IsNotNull(subject);
        }
        ...
        {
            var sourceTest = new JObject();
            sourceTest.Add("srtcpKs", new JValue("00AA"));
        ...
        [Test]
        public void ShouldSetProperSrtpKeFromDynamicAnswerTest()
        {
            var sourceTest = GetSourceAnswerTest();
            var subject = new TestCase(sourceTest);
            Assume.That(subject != null);
            Assert.AreEqual(sourceTest.srtpKe, subject.SrtpKe);
        }
