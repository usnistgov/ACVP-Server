...
";
        ...
        public void ShouldHaveProperNumberOfGroups()
        {
            ...
            Assert.AreEqual(4, vectorSet.TestGroups.Count); //WE NEED TO CHANGE TO 6 WHEN WE IMPLEMENT MCT. 
        }
        ...
        public void ShouldParseDecryptFromFileContents()
        {
            ...
            Assume.That(result != null);
            var vectorSet = result.ParsedObject;
            Assume.That(vectorSet.TestGroups.Count() == 4); //WE NEED TO CHANGE TO 6 WHEN WE IMPLEMENT MCT. 
            var decryptCount = vectorSet.TestGroups.Count(g => ((TestGroup)g).Function.ToLower() == "decrypt");
            Assert.AreEqual(2, decryptCount, decryptCount.ToString()); //WE NEED TO CHANGE TO 3 WHEN WE IMPLEMENT MCT. 
        }
        ...
        public void ShouldParseEncryptFromFileContents()
        {
            ...
            Assert.AreEqual(2, encryptCount, encryptCount.ToString()); //WE NEED TO CHANGE TO 3 WHEN WE IMPLEMENT MCT. 
