	...
	public class MessageProcessorFactory : IMessageProcessorFactory
	{
		...
		public IMessageProcessor GetMessageProcessor(APIAction action)
		{
			return action switch
			{
				...
				APIAction.CancelVectorSet => new CancelVectorSetProcessor(_vectorSetService, _testSessionService, _taskQueueService),
				APIAction.CancelTestSession => new CancelTestSessionProcessor(_testSessionService, _taskQueueService, _vectorSetService),
