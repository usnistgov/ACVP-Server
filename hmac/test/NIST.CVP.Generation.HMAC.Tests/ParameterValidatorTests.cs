...
namespace NIST.CVP.Generation.HMAC.Tests
{
    ...
    public class ParameterValidatorTests
    {
        ...
        [TestCase("test1 - sha1 invalid", "HMAC-SHA-1", 88, false)]
        [TestCase("test2 - sha2-224 valid", "HMAC-SHA2-224", 112, true)]
        [TestCase("test3 - sha2-224 invalid", "HMAC-SHA2-224", 120, false)]
        [TestCase("test4 - sha2-256 valid", "HMAC-SHA2-256", 128, true)]
        [TestCase("test5 - sha2-256 invalid", "HMAC-SHA2-256", 136, false)]
        [TestCase("test6 - sha2-384 valid", "HMAC-SHA2-384", 192, true)]
        [TestCase("test7 - sha2-384 invalid", "HMAC-SHA2-384", 200, false)]
        [TestCase("test8 - sha2-512 valid", "HMAC-SHA2-512", 256, true)]
        [TestCase("test9 - sha2-512 invalid", "HMAC-SHA2-512", 264, false)]
        [TestCase("test10 - sha2-512/224 valid", "HMAC-SHA2-512/224", 112, true)]
        [TestCase("test11 - sha2-512/224 invalid", "HMAC-SHA2-512/224", 120, false)]
        [TestCase("test12 - sha2-512/256 valid", "HMAC-SHA2-512/256", 128, true)]
        [TestCase("test13 - sha2-512/256 invalid", "HMAC-SHA2-512/256", 136, false)]
        [TestCase("test14 - sha3-224 valid", "HMAC-SHA3-224", 112, true)]
        [TestCase("test15 - sha3-224 invalid", "HMAC-SHA3-224", 120, false)]
        [TestCase("test16 - sha3-256 valid", "HMAC-SHA3-256", 128, true)]
        [TestCase("test17 - sha3-256 invalid", "HMAC-SHA3-256", 136, false)]
        [TestCase("test18 - sha3-384 valid", "HMAC-SHA3-384", 192, true)]
        [TestCase("test19 - sha3-384 invalid", "HMAC-SHA3-384", 200, false)]
        [TestCase("test20 - sha3-512 valid", "HMAC-SHA3-512", 256, true)]
        [TestCase("test21 - sha3-512 invalid", "HMAC-SHA3-512", 264, false)]
