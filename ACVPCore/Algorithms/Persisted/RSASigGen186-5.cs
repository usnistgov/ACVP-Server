...
{
	public class RSASigGen186_5 : PersistedAlgorithmBase
	{
		...
		public RSASigGen186_5(ACVPCore.Algorithms.External.RSASigGen186_5 external) : this()
		{
		...
		public class Capability
		{
			...
			public Capability(External.RSASigGen186_5.Capability externalCapability)
			{
		...
		public class Property
		{
			...
			public Property(External.RSASigGen186_5.Property externalProperty)
			{
		...
		public class HashPair
		{
			...
			public HashPair() { }
			public HashPair(External.RSASigGen186_5.HashPair externalHashPair)
			{
