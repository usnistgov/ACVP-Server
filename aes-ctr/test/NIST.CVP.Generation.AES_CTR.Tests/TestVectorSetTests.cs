...
namespace NIST.CVP.Generation.AES_CTR.Tests
{
    ...
    public class TestVectorSetTests
    {
        ...
        [Test]
        public void CounterEncryptShouldIncludeKeyWithinAnswerProjection()
        {
            ...
            {
                Assert.IsTrue(!string.IsNullOrEmpty(item.key.ToString()));
            }
        }

        [Test]
        public void CounterDecryptShouldIncludeKeyWithinAnswerProjection()
        {
        ...
        [Test]
        public void CounterEncryptShouldIncludeKeyAndPlainTextWithinPromptProjection()
        {
            var subject = GetCounterSubject();
            var results = subject.PromptProjection;
            var group = results[0];
        ...
        [Test]
        public void CounterDecryptShouldIncludeKeyAndCipherTextWithinPromptProjection()
        {
            var subject = GetCounterSubject(1, "decrypt");
            var results = subject.PromptProjection;
            var group = results[0];
        ...
        [Test]
        public void CounterEncryptShouldExcludeCipherTextPromptProjection()
        {
            var subject = GetCounterSubject();
            var results = subject.PromptProjection;
            var group = results[0];
        ...
        [Test]
        public void CounterDecryptShouldExcludePlainTextWithinPromptProjection()
        {
            var subject = GetCounterSubject(1, "decrypt");
            var results = subject.PromptProjection;
            var group = results[0];
        ...
        [Test]
        public void CounterEncryptShouldIncludeIVsAndCipherTextInResultProjection()
        {
            var subject = GetCounterSubject();
            var results = subject.ResultProjection;
            var group = results[0];
        ...
        [Test]
        public void CounterDecryptShouldIncludeIVsAndPlainTextInResultProjection()
        {
            var subject = GetCounterSubject(1, "decrypt");
            var results = subject.ResultProjection;
            var group = results[0];
