...
namespace NIST.CVP.Generation.AES_CFB1.IntegrationTests
{
    ...
    public class MMTs
    {
        ...
        public void ShouldMMTDecrypt1Byte192BitKey()
        {
            ...
            BitString cipherText = BitString.GetBitStringEachCharacterOfInputIsBit("10");
            BitString expectedPlainText = BitString.GetBitStringEachCharacterOfInputIsBit("10");
        ...
        public void ShouldMMTDecryptMultipleBytes192BitKey()
        {
            ...
            BitString cipherText = BitString.GetBitStringEachCharacterOfInputIsBit("1000110010");
            BitString expectedPlainText = BitString.GetBitStringEachCharacterOfInputIsBit("1100100011");
        ...
        public void ShouldMMTDecrypt1Byte256BitKey()
        {
            ...
            BitString cipherText = BitString.GetBitStringEachCharacterOfInputIsBit("00");
            BitString expectedPlainText = BitString.GetBitStringEachCharacterOfInputIsBit("00");
        ...
        public void ShouldMMTDecryptMultipleBytes256BitKey()
        {
            ...
            BitString cipherText = BitString.GetBitStringEachCharacterOfInputIsBit("1111101010");
            BitString expectedPlainText = BitString.GetBitStringEachCharacterOfInputIsBit("0101100011");
