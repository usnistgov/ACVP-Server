...
namespace NIST.CVP.Generation.AES_CFB1
{
    public class TestCaseGeneratorFactory : ITestCaseGeneratorFactory<TestGroup, TestCase>
    {
        ...
        private readonly IAES_CFB1_MCT _algoMct;

        public TestCaseGeneratorFactory(IRandom800_90 random800_90, IAES_CFB1 algo, IAES_CFB1_MCT algoMct)
        {
        ...
        public ITestCaseGenerator<TestGroup, TestCase> GetCaseGenerator(TestGroup testGroup)
        {
            ...
            switch (testType)
            {
                ...
                case "mct":
                    ...
                    {
                        case "encrypt":
                            return new TestCaseGeneratorMCTEncrypt(_random800_90, _algoMct);
                        case "decrypt":
                            return new TestCaseGeneratorMCTDecrypt(_random800_90, _algoMct);
                    }
                    break;
                case "mmt":
                    switch (direction)
