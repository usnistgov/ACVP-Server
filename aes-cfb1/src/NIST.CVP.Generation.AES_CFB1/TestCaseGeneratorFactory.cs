...
namespace NIST.CVP.Generation.AES_CFB1
{
    public class TestCaseGeneratorFactory : ITestCaseGeneratorFactory<TestGroup, TestCase>
    {
        ...
        private readonly IAES_CFB1 _aesOfb;
        private readonly IAES_CFB1_MCT _aesOfbMct;

        public TestCaseGeneratorFactory(IRandom800_90 random800_90, IAES_CFB1 aesOfb, IAES_CFB1_MCT aesOfbMct)
        {
