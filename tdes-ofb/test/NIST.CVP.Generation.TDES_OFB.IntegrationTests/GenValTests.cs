...
namespace NIST.CVP.Generation.TDES_OFB.IntegrationTests
{
    ...
    public class GenValTests
    {
        ...
        {
            var result = tdes_ofb.Program.Main(new string[] { });
        ...
        {
            var result = tdes_ofb.Program.Main(new string[] { $"{Guid.NewGuid()}.json" });
        ...
        public void GenShouldReturn1OnFailedRun()
        {
            ...
            var result = tdes_ofb.Program.Main(new string[] { fileName });
        ...
        public void ValShouldReturn1OnFailedRun()
        {
            ...
            var result = TDES_OFB_Val.Program.Main(
