CREATE TABLE [dbo].[Implementations] (
    ...
    CONSTRAINT [FK_Implementations_AddressId] FOREIGN KEY ([AddressId]) REFERENCES [val].[ADDRESS] ([id]),
    ...
    CONSTRAINT [FK_Implementations_VendorId] FOREIGN KEY ([VendorId]) REFERENCES [val].[ORGANIZATION] ([id])
);
