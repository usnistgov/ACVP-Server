...
SELECT request.id, request.action_id, request.user_id, workflow.created_on, workflow.type, workflow.status, workflow.accept_id, workflow.APIActionID as apiActionId
