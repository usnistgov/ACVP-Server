...
GO
CREATE NONCLUSTERED INDEX [IX_VALIDATION_CAPABILITY_root]
    ON [val].[VALIDATION_CAPABILITY]([root] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_VALIDATION_CAPABILITY_parent]
    ON [val].[VALIDATION_CAPABILITY]([parent] ASC);
