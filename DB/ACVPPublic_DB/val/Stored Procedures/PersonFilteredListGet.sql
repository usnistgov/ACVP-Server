CREATE PROCEDURE [val].[PersonFilteredListGet]
				...
				if (@PropertyID = 0)
					BEGIN
						...
						WHERE 1 = CASE
									...
									WHEN @PropertyName = 'vendorId' AND @Operator = 'eq' AND org_id = CAST(@Value as bigint) THEN 1
									WHEN @PropertyName = 'vendorId' AND @Operator = 'ne' AND org_id <> CAST(@Value as bigint) THEN 1
									WHEN @PropertyName = 'vendorId' AND @Operator = 'lt' AND org_id < CAST(@Value as bigint) THEN 1
									WHEN @PropertyName = 'vendorId' AND @Operator = 'le' AND org_id <= CAST(@Value as bigint) THEN 1
									WHEN @PropertyName = 'vendorId' AND @Operator = 'gt' AND org_id > CAST(@Value as bigint) THEN 1
