...
namespace LCAVPCore.Registration.Algorithms.SHS
{
	public class SHA_512256 : AlgorithmBase, IAlgorithm
	{
		...
		public SHA_512256(Dictionary<string, string> options) : base("SHA2-512/256")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.SHA2_512256
		{
