...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_CMAC : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.AES_CMAC
		{
			Capabilities = Capabilities.Select(x => new ACVPCore.Algorithms.Persisted.AES_CMAC.Capability
			{
