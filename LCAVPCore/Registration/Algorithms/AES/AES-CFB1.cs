...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_CFB1 : AlgorithmBase, IAlgorithm
	{
		...
		public AES_CFB1(Dictionary<string, string> options) : base("ACVP-AES-CFB1")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.AES_CFB1
		{
			Direction = Direction,
			KeyLength = KeyLen
		};
