...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_ECB : AlgorithmBase, IAlgorithm
	{
		...
		public AES_ECB(Dictionary<string, string> options) : base("ACVP-AES-ECB")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.AES_ECB
		{
			Direction = Direction,
			KeyLength = KeyLen
		};
