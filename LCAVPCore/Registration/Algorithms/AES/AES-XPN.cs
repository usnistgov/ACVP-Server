...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_XPN : AlgorithmBase, IAlgorithm
	{
		...
		public AES_XPN(string ivGenLocation, string ivGenMode, Dictionary<string, string> options) : base("ACVP-AES-XPN")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.AES_XPN
		{
			Direction = Direction,
			KeyLength = KeyLen,
