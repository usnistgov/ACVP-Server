...
namespace LCAVPCore.Registration.Algorithms.AES
{
	public class AES_GMAC : AlgorithmBase, IAlgorithm
	{
		...
		public AES_GMAC(string ivGenLocation, string ivGenMode, Dictionary<string, string> options) : base("ACVP-AES-GMAC")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.AES_GMAC
		{
			Direction = Direction,
			KeyLength = KeyLen,
