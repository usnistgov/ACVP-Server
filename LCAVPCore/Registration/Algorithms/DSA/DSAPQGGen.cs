...
namespace LCAVPCore.Registration.Algorithms.DSA
{
	public class DSAPQGGen : AlgorithmBase, IAlgorithm
	{
		...
		public DSAPQGGen(Dictionary<string, string> options) : base("DSA", "pqgGen")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.DSAPQGGen186_4
		{
