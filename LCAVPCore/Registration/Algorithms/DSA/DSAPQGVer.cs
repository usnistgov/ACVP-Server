...
namespace LCAVPCore.Registration.Algorithms.DSA
{
	public class DSAPQGVer : AlgorithmBase, IAlgorithm
	{
		...
		public DSAPQGVer(Dictionary<string, string> options) : base("DSA", "pqgVer")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.DSAPQGVer186_4
		{
