...
namespace LCAVPCore.Registration.Algorithms.DSA
{
	public class DSAKeyPair : AlgorithmBase, IAlgorithm
	{
		...
		public DSAKeyPair(Dictionary<string, string> options) : base("DSA", "keyGen")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.DSAKeyGen186_4
		{
