...
namespace LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_ECB : AlgorithmBase, IAlgorithm
	{
		...
		public TDES_ECB(Dictionary<string, string> options) : base("ACVP-TDES-ECB")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.TDES_ECB
		{
			Direction = Direction,
