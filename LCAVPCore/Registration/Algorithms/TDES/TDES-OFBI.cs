...
namespace LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_OFBI : AlgorithmBase, IAlgorithm
	{
		...
		public TDES_OFBI(Dictionary<string, string> options): base("ACVP-TDES-OFBI")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.TDES_OFBI
		{
			Direction = Direction,
