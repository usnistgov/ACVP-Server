...
namespace LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_CFB1 : AlgorithmBase, IAlgorithm
	{
		...
		public TDES_CFB1(Dictionary<string, string> options) : base("ACVP-TDES-CFB1")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.TDES_CFB1
		{
			Direction = Direction,
