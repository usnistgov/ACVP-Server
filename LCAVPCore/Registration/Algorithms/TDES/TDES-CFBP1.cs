...
namespace LCAVPCore.Registration.Algorithms.TDES
{
	public class TDES_CFBP1 : AlgorithmBase, IAlgorithm
	{
		...
		public TDES_CFBP1(Dictionary<string, string> options) : base("ACVP-TDES-CFBP1")
		{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.TDES_CFBP1
		{
			Direction = Direction,
