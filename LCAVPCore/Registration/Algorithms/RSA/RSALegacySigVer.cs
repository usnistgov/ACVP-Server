...
namespace LCAVPCore.Registration.Algorithms.RSA
{
	public class RSALegacySigVer : AlgorithmBase, IAlgorithm
	{
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.RSASigVer186_2
		{
			Capabilities = Capabilities.Select(x => new ACVPCore.Algorithms.Persisted.RSASigVer186_2.Capability
			{
