...
namespace LCAVPCore.Registration.Algorithms.KAS
{
	public class Component_KAS_ECC : AlgorithmBase, IAlgorithm
	{
		...
		public Component_KAS_ECC(Dictionary<string, string> options) : base("KAS-ECC", "Component")
		{
			//Prereqs
		...
		public class ParameterSet
		{
			...
			public ACVPCore.Algorithms.Persisted.KAS_ECC_Component.ParameterSet ToPersisted() => new ACVPCore.Algorithms.Persisted.KAS_ECC_Component.ParameterSet
			{
				Curve = Curve,
				HashAlg = HashAlg
			};
