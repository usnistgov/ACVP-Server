...
namespace LCAVPCore.Registration.Algorithms.Component
{
	public class IKEv1 : AlgorithmBase, IAlgorithm
	{
		...
		public IKEv1(Dictionary<string, string> options) : base("kdf-components", "ikev1")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.KDF_IKEv1
		{
