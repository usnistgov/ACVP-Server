...
namespace LCAVPCore.Registration.Algorithms.HMAC
{
	public class HMAC_SHA_1 : AlgorithmBase, IAlgorithm
	{
		...
		public HMAC_SHA_1(Dictionary<string, string> options) : base("HMAC-SHA-1")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.HMAC_SHA_1
		{
