...
namespace LCAVPCore.Registration.Algorithms.HMAC
{
	public class HMAC_SHA2_512 : AlgorithmBase, IAlgorithm
	{
		...
		public HMAC_SHA2_512(Dictionary<string, string> options) : base("HMAC-SHA2-512")
		{
			//Prereqs
		...
		public IPersistedAlgorithm ToPersistedAlgorithm() => new ACVPCore.Algorithms.Persisted.HMAC_SHA2_512
		{
