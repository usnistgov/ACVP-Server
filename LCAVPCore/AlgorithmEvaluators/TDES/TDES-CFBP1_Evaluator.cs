...
{
	public class TDES_CFBP1_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public TDES_CFBP1_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new TDES_CFBP1_ResultsExtractor(SubmissionPath);
			...
			switch (Options.GetValue("CFBP1_State"))
			{
				case "Decrypt":
				...
				default:
						algoResult.AddFailure("Invalid CFBP1 State");
						break;
				}
			}
