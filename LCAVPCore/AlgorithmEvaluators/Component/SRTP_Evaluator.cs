...
{
	public class SRTP_Evaluator : AlgorithmEvaluatorBase, IAlgorithmEvaluator
	{
		public SRTP_Evaluator(Dictionary<string, string> options, string submissionPath) : base(options, submissionPath)
		{
		}
		...
		public AlgorithmEvaluationResult Evaluate()
		{
			...
			var resultExtractor = new SRTP_ResultsExtractor(SubmissionPath);
