using System.IO;
using System.Linq;
using LCAVPCore.AlgorithmResults.SHS;

namespace LCAVPCore.AlgorithmResultsExtractors.SHS
{
	public class SHA_512224_ResultsExtractor : IAlgorithmResultsExtractor
	{
		private const string SUMMARY_FILE_NAME = "SHA_Summary.txt";
		private string _summaryFilePath;

		public SHA_512224_ResultsExtractor(string submissionPath)
		{
			_summaryFilePath = Path.Combine(submissionPath, SUMMARY_FILE_NAME);
		}

		public SHA_512224_Results Extract()
		{
			SHA_512224_Results results = new SHA_512224_Results();
			...
			string passLineValue = ParsingHelper.GetValueStringFromSummaryLinesByKey(lines, "[SHA-512/224]");
