...
namespace NIST.CVP.Generation.KAS.ECC.Tests
{
    ...
    public class TestCaseGeneratorValKdfNoKcTests
    {
        ...
        [TestCase(EccScheme.StaticUnified, KeyAgreementRole.InitiatorPartyU, KeyAgreementMacType.AesCcm, TestCaseDispositionOption.FailAssuranceServerEphemeralPublicKey, false)] // does not generate ephemeral key
        ...
        [TestCase(EccScheme.StaticUnified, KeyAgreementRole.InitiatorPartyU, KeyAgreementMacType.CmacAes, TestCaseDispositionOption.FailAssuranceServerEphemeralPublicKey, false)] // does not generate ephemeral key
        ...
        [TestCase(EccScheme.StaticUnified, KeyAgreementRole.InitiatorPartyU, KeyAgreementMacType.HmacSha2D224, TestCaseDispositionOption.FailAssuranceServerEphemeralPublicKey, false)] // does not generate ephemeral key
