...
namespace NIST.CVP.Generation.RSA_KeyGen
{
        ...
        where TTestCase : ITestCase
    {
        ...
        public Validator(IDynamicParser dynamicParser, IResultValidator<TTestCase> resultValidator,
            ITestCaseValidatorFactory<TTestVectorSet, TTestCase> testCaseValidatorFactory,
            ITestReconstitutor<TTestVectorSet, TTestCase> testReconstitutor)
        {
        ...
        {
            var testVectorSet =
                _testReconstitutor.GetTestVectorSetExpectationFromResponse(answerParseResponse.ParsedObject,
                    promptParseResponse.ParsedObject);
