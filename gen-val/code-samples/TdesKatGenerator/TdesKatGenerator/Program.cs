...
namespace TdesKatGenerator
{
    public class Program
    {
        ...
        private static void GeneratePermutationThreeBlock()
        {
            var kats = new List<AlgoArrayResponse>();
            var tdes = new CbciBlockCipher(new TdesEngine());

            (var csv, var writer) = GetCSVWriter("permutation-three-block");
        ...
        private static void GenerateSubstitutionThreeBlock()
        {
            var kats = new List<AlgoArrayResponse>();
            var tdes = new CbciBlockCipher(new TdesEngine());

            (var csv, var writer) = GetCSVWriter("substitution-three-block");
        ...
        private static void GenerateInversePermutationThreeBlock()
        {
            var original = new AlgoArrayResponse
            {
                PlainText = BitString.Zeroes(64 * 3),
            ...
            (var csv, var writer) = GetCSVWriter("inverse-permutation-three-block");
        ...
        private static void GenerateVariableTextThreeBlock()
        {
            var original = new AlgoArrayResponse
            {
                PlainText = BitString.Zeroes(64 * 3),
            ...
            (var csv, var writer) = GetCSVWriter("variable-text-three-block");
        ...
        private static void GenerateVariableKeyThreeBlock()
        {
            var original = new AlgoArrayResponse
            {
                PlainText = BitString.Zeroes(64 * 3),
            ...
            (var csv, var writer) = GetCSVWriter("variable-key-three-block");
