...
using NIST.CVP.Generation.KAS.Sp800_56Ar3.Ffc.ContractResolvers;
using NIST.CVP.Math;
...
namespace NIST.CVP.Generation.KAS.Sp800_56Ar3.Ffc
{
    public class RegisterInjections : ISupportedAlgoModeRevisions
    {
        ...
        public void RegisterTypes(ContainerBuilder builder, AlgoMode algoMode)
        {
            ...
            builder.RegisterType<TestCaseValidatorFactory<TestVectorSet, TestGroup, TestCase, FfcKeyPair>>().AsImplementedInterfaces();
