...
using NIST.CVP.ACVTS.Libraries.Generation.ConditioningComponents.Sp800_90B.BlockCipher_DF.ContractResolvers;
...
namespace NIST.CVP.ACVTS.Libraries.Generation.ConditioningComponents.Sp800_90B.BlockCipher_DF
{
    public class RegisterInjections : ISupportedAlgoModeRevisions
    {
        ...
        {
            AlgoMode.ConditioningComponent_BlockCipher_DF_90B
        };
