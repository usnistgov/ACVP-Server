...
namespace NIST.CVP.ACVTS.Libraries.Generation.KDF_Components.v1_0.SNMP.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet, TestGroup, TestCase>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            var testVectorSet = new TestVectorSet { Algorithm = "kdf-components", Mode = "snmp", TestGroups = groups.Select(g => g).ToList() };
