...
namespace NIST.CVP.ACVTS.Libraries.Generation.KDF_Components.v1_0.IKEv2.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet, TestGroup, TestCase>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            var testVectorSet = new TestVectorSet { Algorithm = "kdf-components", Mode = "ikev2", TestGroups = groups.Select(g => g).ToList() };
