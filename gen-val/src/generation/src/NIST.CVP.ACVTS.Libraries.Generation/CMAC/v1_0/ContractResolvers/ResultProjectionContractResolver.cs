...
namespace NIST.CVP.ACVTS.Libraries.Generation.CMAC.v1_0.ContractResolvers
{
            ...
            if (jsonProperty.UnderlyingName == nameof(TestCase.Mac))
            {
                return jsonProperty.ShouldSerialize =
                    instance =>
                    {
                        ...
                        if (testGroup.Function.Equals("gen", StringComparison.OrdinalIgnoreCase))
                        {
                            return true;
                        }
