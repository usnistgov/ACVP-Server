...
namespace NIST.CVP.ACVTS.Libraries.Generation.AES_CBC.v1_0.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet, TestGroup, TestCase>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            var testVectorSet = new TestVectorSet { Algorithm = "AES-CBC", TestGroups = groups.Select(g => g).ToList() };
