        ...
        public ITestCaseGeneratorAsync<TestGroup, TestCase> GetCaseGenerator(TestGroup testGroup)
        {
                ...
                && testGroup.IsSample)
            {
                ...
                var validityTestCaseOptions =
                    new TestCaseExpectationProvider<TestGroup, TestCase, EccKeyPair>(testGroup, false);
            ...
            {
                var validityTestCaseOptions =
                    new TestCaseExpectationProvider<TestGroup, TestCase, EccKeyPair>(testGroup, true);
                return new TestCaseGeneratorVal(_oracle, validityTestCaseOptions);
            }
