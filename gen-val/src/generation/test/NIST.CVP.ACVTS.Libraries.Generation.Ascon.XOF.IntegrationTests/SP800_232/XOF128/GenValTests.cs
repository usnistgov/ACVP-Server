...
namespace NIST.CVP.ACVTS.Libraries.Generation.Ascon.XOF128.IntegrationTests;

[TestFixture, FastIntegrationTest]
public class GenValTests : GenValTestsSingleRunnerBase
{
    public override string Algorithm { get; } = "Ascon";
    public override string Mode { get; } = "XOF128";
    public override string Revision { get; set; } = "SP800-232";

    public override AlgoMode AlgoMode => AlgoMode.ASCON_XOF128_SP800_232;
