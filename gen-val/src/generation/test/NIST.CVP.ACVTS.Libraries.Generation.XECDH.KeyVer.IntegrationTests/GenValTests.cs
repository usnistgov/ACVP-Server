...
namespace NIST.CVP.ACVTS.Libraries.Generation.XECDH.KeyVer.IntegrationTests
{
    ...
    public class GenValTests : GenValTestsSingleRunnerBase
    {
        ...
        public override AlgoMode AlgoMode => AlgoMode.XECDH_KeyVer_RFC7748;
