...
namespace NIST.CVP.ACVTS.Libraries.Generation.HMAC.IntegrationTests.v2_0
{
    ...
    public abstract class GenValHmacBase : GenValTestsSingleRunnerBase
    {
        ...
        public override string Revision => "2.0";
        ...
        protected override string GetTestFileFewTestCases(string targetFolder)
        {
            Parameters p = new Parameters
            {
                ...
                MessageLen = new MathDomain().AddSegment(new ValueDomainSegment(1024)),
                IsSample = false
            };
        ...
        protected override string GetTestFileLotsOfTestCases(string targetFolder)
        {
            ...
            Parameters p = new Parameters
            {
                ...
                MessageLen = new MathDomain().AddSegment(new RangeDomainSegment(random, 0, 1024, 8)),
                IsSample = false
            };
