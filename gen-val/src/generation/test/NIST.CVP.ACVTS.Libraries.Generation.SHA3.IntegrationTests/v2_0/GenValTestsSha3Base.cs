...
namespace NIST.CVP.ACVTS.Libraries.Generation.SHA3.IntegrationTests.v2_0
{
    public abstract class GenValTestsSha3Base : GenValTestsSingleRunnerBase
    {
        ...
        {
            MathDomain dom = new MathDomain()
                .AddSegment(new RangeDomainSegment(new Random800_90(), ParameterValidator.VALID_MIN_MESSAGE_LENGTH, ParameterValidator.VALID_MAX_MESSAGE_LENGTH));
