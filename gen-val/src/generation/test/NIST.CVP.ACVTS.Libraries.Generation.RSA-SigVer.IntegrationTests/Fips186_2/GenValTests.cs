...
using ParameterValidator = NIST.CVP.ACVTS.Libraries.Generation.RSA.v1_0.LegacySigVer.ParameterValidator;
using RegisterInjections = NIST.CVP.ACVTS.Libraries.Generation.RSA.v1_0.LegacySigVer.RegisterInjections;

namespace NIST.CVP.ACVTS.Libraries.Generation.RSA_SigVer.IntegrationTests.Fips186_2
{
    ...
    public class GenValTests : GenValTestsSingleRunnerBase
    {
        ...
        public override string Revision => "FIPS186-2";
