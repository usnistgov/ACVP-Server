...
using NIST.CVP.ACVTS.Libraries.Generation.LMS.v1_0.SigVer.ContractResolvers;
using NIST.CVP.ACVTS.Tests.Core.TestCategoryAttributes;
using NUnit.Framework;

namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.LMS.SigVer.ContractResolvers
{
    ...
    public class PromptProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeGroupProperties()
        {
            ...
            Assert.AreEqual(tg.LmsTypes, newTg.LmsTypes, nameof(newTg.LmsTypes));
            Assert.AreEqual(tg.LmotsTypes, newTg.LmotsTypes, nameof(newTg.LmotsTypes));
        }
