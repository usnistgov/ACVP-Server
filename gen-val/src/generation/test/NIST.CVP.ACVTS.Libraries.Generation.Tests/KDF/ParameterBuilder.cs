...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.KDF
{
    ...
    public class CapabilityBuilder
    {
        ...
        private int _customKeyInLength;
        ...
        public CapabilityBuilder WithCustomKeyInLength(int value)
        {
            _customKeyInLength = value;
            return this;
        }
        ...
        public Capability Build()
        {
            return new Capability
            {
                ...
                CustomKeyInLength = _customKeyInLength
            };
        }
    }
}
