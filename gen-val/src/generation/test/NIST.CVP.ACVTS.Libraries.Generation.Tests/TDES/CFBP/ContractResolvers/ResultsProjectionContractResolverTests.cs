    ...
    public class ResultsProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeEncryptCaseProperties(string function, string testType)
        {
            ...
            else
            {
                ...
                Assert.That(newTc.CipherText1, Is.EqualTo(tc.CipherText1), nameof(newTc.CipherText1));
                Assert.That(newTc.CipherText2, Is.EqualTo(tc.CipherText2), nameof(newTc.CipherText2));
                Assert.That(newTc.CipherText3, Is.EqualTo(tc.CipherText3), nameof(newTc.CipherText3));
            ...
            Assert.That(newTc.PlainText1, Is.Not.EqualTo(tc.PlainText1), nameof(newTc.PlainText1));
            Assert.That(newTc.PlainText2, Is.Not.EqualTo(tc.PlainText2), nameof(newTc.PlainText2));
            Assert.That(newTc.PlainText3, Is.Not.EqualTo(tc.PlainText3), nameof(newTc.PlainText3));
        ...
        public void ShouldSerializeDecryptCaseProperties(string function, string testType)
        {
            ...
            else
            {
                ...
                Assert.That(newTc.PlainText1, Is.EqualTo(tc.PlainText1), nameof(newTc.PlainText1));
                Assert.That(newTc.PlainText2, Is.EqualTo(tc.PlainText2), nameof(newTc.PlainText2));
                Assert.That(newTc.PlainText3, Is.EqualTo(tc.PlainText3), nameof(newTc.PlainText3));
                Assert.That(newTc.ResultsArray, Is.Null, nameof(newTc.ResultsArray));
            }
            ...
            Assert.That(newTc.CipherText1, Is.Not.EqualTo(tc.CipherText1), nameof(newTc.CipherText1));
            Assert.That(newTc.CipherText2, Is.Not.EqualTo(tc.CipherText2), nameof(newTc.CipherText2));
            Assert.That(newTc.CipherText3, Is.Not.EqualTo(tc.CipherText3), nameof(newTc.CipherText3));
            Assert.That(newTc.Deferred, Is.Not.EqualTo(tc.Deferred), nameof(newTc.Deferred));
