...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.KAS.ECC.ContractResolvers
{
    ...
    public class PromptProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeCasePropertiesNoKdfNoKc(KasMode kasMode, string testType)
        {
            ...
            Assert.That(newTc.StaticPublicKeyServerX, Is.EqualTo(tc.StaticPublicKeyServerX), nameof(newTc.StaticPublicKeyServerX));
            Assert.That(newTc.StaticPublicKeyServerY, Is.EqualTo(tc.StaticPublicKeyServerY), nameof(newTc.StaticPublicKeyServerY));
            Assert.That(newTc.EphemeralPublicKeyServerX, Is.EqualTo(tc.EphemeralPublicKeyServerX), nameof(newTc.EphemeralPublicKeyServerX));
            Assert.That(newTc.EphemeralPublicKeyServerY, Is.EqualTo(tc.EphemeralPublicKeyServerY), nameof(newTc.EphemeralPublicKeyServerY));
            ...
            if (testType == "val")
            {
                ...
                Assert.That(newTc.StaticPublicKeyIutX, Is.EqualTo(tc.StaticPublicKeyIutX), nameof(newTc.StaticPublicKeyIutX));
                Assert.That(newTc.StaticPublicKeyIutY, Is.EqualTo(tc.StaticPublicKeyIutY), nameof(newTc.StaticPublicKeyIutY));
                Assert.That(newTc.EphemeralPrivateKeyIut, Is.EqualTo(tc.EphemeralPrivateKeyIut), nameof(newTc.EphemeralPrivateKeyIut));
                Assert.That(newTc.EphemeralPublicKeyIutX, Is.EqualTo(tc.EphemeralPublicKeyIutX), nameof(newTc.EphemeralPublicKeyIutX));
                Assert.That(newTc.EphemeralPublicKeyIutY, Is.EqualTo(tc.EphemeralPublicKeyIutY), nameof(newTc.EphemeralPublicKeyIutY));
            ...
            if (testType == "aft")
            {
                ...
                Assert.That(newTc.StaticPublicKeyIutX, Is.Not.EqualTo(tc.StaticPublicKeyIutX), nameof(newTc.StaticPublicKeyIutX));
                Assert.That(newTc.StaticPublicKeyIutY, Is.Not.EqualTo(tc.StaticPublicKeyIutY), nameof(newTc.StaticPublicKeyIutY));
                Assert.That(newTc.EphemeralPrivateKeyIut, Is.Not.EqualTo(tc.EphemeralPrivateKeyIut), nameof(newTc.EphemeralPrivateKeyIut));
                Assert.That(newTc.EphemeralPublicKeyIutX, Is.Not.EqualTo(tc.EphemeralPublicKeyIutX), nameof(newTc.EphemeralPublicKeyIutX));
                Assert.That(newTc.EphemeralPublicKeyIutY, Is.Not.EqualTo(tc.EphemeralPublicKeyIutY), nameof(newTc.EphemeralPublicKeyIutY));
