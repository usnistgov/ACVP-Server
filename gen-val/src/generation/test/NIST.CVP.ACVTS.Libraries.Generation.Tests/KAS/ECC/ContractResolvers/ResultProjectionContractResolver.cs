...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.KAS.ECC.ContractResolvers
{
    ...
    public class ResultsProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeGroupProperties(string testType, KasMode kasMode, KeyAgreementMacType macType, KeyConfirmationRole kcRole, KeyConfirmationDirection kcType)
        {
            ...
            Assert.That(newTg.KasRole, Is.Not.EqualTo(tg.KasRole), nameof(newTg.KasRole));
        ...
        public void ShouldSerializeCasePropertiesNoKdfNoKc(string testType, KasMode kasMode)
        {
            ...
            if (testType == "aft")
            {
                ...
                Assert.That(newTc.StaticPublicKeyIutX.ToPositiveBigInteger(), Is.EqualTo(tc.StaticPublicKeyIutX.ToPositiveBigInteger()), nameof(newTc.StaticPublicKeyIutX));
                Assert.That(newTc.StaticPublicKeyIutY.ToPositiveBigInteger(), Is.EqualTo(tc.StaticPublicKeyIutY.ToPositiveBigInteger()), nameof(newTc.StaticPublicKeyIutY));
                Assert.That(newTc.EphemeralPublicKeyIutX.ToPositiveBigInteger(), Is.EqualTo(tc.EphemeralPublicKeyIutX.ToPositiveBigInteger()), nameof(newTc.EphemeralPublicKeyIutX));
                Assert.That(newTc.EphemeralPublicKeyIutY.ToPositiveBigInteger(), Is.EqualTo(tc.EphemeralPublicKeyIutY.ToPositiveBigInteger()), nameof(newTc.EphemeralPublicKeyIutY));
            ...
            Assert.That(newTc.StaticPrivateKeyIut, Is.Null, nameof(newTc.StaticPrivateKeyIut));
            Assert.That(newTc.EphemeralPrivateKeyIut, Is.Null, nameof(newTc.EphemeralPrivateKeyIut));
