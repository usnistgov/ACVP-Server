...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.KAS.IFC
{
    ...
    {
        public static TestVectorSet GetVectorSet(string testType, Kda kdfType)
        {
            ...
            var tg = new TestGroup()
            {
                ...
                {
                    L = 512,
                    AuxFunction = KdaOneStepAuxFunction.KMAC_128,
                    SaltLen = 128,
            ...
            tg.Tests = new List<TestCase>()
            {
                new TestCase()
                {
                    ...
                    TestPassed = true,
                    TestCaseDisposition = KasIfcValTestDisposition.Success
                }
            };
