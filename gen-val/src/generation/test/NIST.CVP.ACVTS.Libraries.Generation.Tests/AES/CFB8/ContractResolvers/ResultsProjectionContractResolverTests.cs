...
using NIST.CVP.ACVTS.Libraries.Generation.AES_CFB8.v1_0.ContractResolvers;
...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.AES.CFB8.ContractResolvers
{
