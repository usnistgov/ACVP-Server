...
using NIST.CVP.ACVTS.Libraries.Generation.AES_CBC.v1_0.Parsers;
using NIST.CVP.ACVTS.Tests.Core;
using NIST.CVP.ACVTS.Tests.Core.TestCategoryAttributes;
using NUnit.Framework;

namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.AES.CBC.Parsers
{
...
";
        ...
        public void ShouldHaveProperNumberOfGroups()
        {
            ...
            Assert.That(vectorSet.TestGroups.Count, Is.EqualTo(_expectedTotalGroups));
        }
        ...
        public void ShouldHaveTestsWithKeyFilled()
        {
            ...
            Assert.That(casesWithKey, Is.Not.Empty);
        }
        ...
        public void ShouldParseDecryptFromFileContents()
        {
            ...
            Assert.That(result != null);
            var vectorSet = result.ParsedObject;
            Assert.That(vectorSet.TestGroups.Count() == _expectedTotalGroups);
