...
using NIST.CVP.ACVTS.Libraries.Generation.AES_CFB128.v1_0.ContractResolvers;
...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.AES.CFB128.ContractResolvers
{
