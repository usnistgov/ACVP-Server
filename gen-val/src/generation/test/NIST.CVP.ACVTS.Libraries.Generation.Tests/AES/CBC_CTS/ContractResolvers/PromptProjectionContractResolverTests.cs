...
using NIST.CVP.ACVTS.Libraries.Generation.AES_CBC_CTS.v1_0.ContractResolvers;
...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.AES.CBC_CTS.ContractResolvers
{
    ...
    public class PromptProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeEncryptCaseProperties(string function, string testType)
        {
            ...
            Assert.That(newTc.PayloadLen, Is.EqualTo(tc.PayloadLen), nameof(newTc.PayloadLen));
