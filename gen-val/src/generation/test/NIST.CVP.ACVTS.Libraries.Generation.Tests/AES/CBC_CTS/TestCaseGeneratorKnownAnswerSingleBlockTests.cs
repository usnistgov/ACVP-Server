...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.AES.CBC_CTS
{
    ...
    public class TestCaseGeneratorKnownAnswerSingleBlockTests
    {
        private TestCaseGeneratorKnownAnswerSingleBlock _subject;
        ...
        public async Task ShouldReturnResponseWithCollectionMatchingKeySize(int keyLength, string katType)
        {
            ...
            _subject = new TestCaseGeneratorKnownAnswerSingleBlock(keyLength, katType);
