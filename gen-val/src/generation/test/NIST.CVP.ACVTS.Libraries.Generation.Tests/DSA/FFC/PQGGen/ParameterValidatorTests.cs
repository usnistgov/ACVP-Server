        ...
        public void ShouldReturnErrorWithInvalidPQMode(object[] mode)
        {
            ...
            var result = subject.Validate(
                new ParameterBuilder()
                    ...
                    {
                        ParameterBuilder.GetCapabilityWith(2048, 224, strModes, ParameterValidator.VALID_G_MODES, ParameterValidator.VALID_HASH_ALGS)
                    })
                    .Build());
        ...
        public void ShouldReturnErrorWithInvalidGMode(object[] mode)
        {
            ...
            var result = subject.Validate(
                new ParameterBuilder()
                    .WithCapabilities(new[]
                    {
                        ParameterBuilder.GetCapabilityWith(2048, 224, ParameterValidator.VALID_PQ_MODES, strModes, ParameterValidator.VALID_HASH_ALGS)
                    })
                    .Build());
        ...
        public void ShouldReturnErrorWithInvalidLNPair(int L, int N)
        {
            ...
            var result = subject.Validate(
                new ParameterBuilder()
                    .WithCapabilities(new[]
                    {
                        ParameterBuilder.GetCapabilityWith(L, N, ParameterValidator.VALID_PQ_MODES, ParameterValidator.VALID_G_MODES, ParameterValidator.VALID_HASH_ALGS)
                    })
                    .Build());
