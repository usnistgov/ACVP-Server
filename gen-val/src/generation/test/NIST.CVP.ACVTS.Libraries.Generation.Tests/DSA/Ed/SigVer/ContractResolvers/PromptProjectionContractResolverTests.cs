...
using NIST.CVP.ACVTS.Libraries.Generation.EDDSA.v1_0.SigVer.ContractResolvers;
using NIST.CVP.ACVTS.Tests.Core.TestCategoryAttributes;
using NUnit.Framework;

namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.DSA.Ed.SigVer.ContractResolvers
{
    ...
    public class PromptProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeCaseProperties(int curve, bool preHash)
        {
            ...
            Assert.That(newTc.Sig, Is.EqualTo(tc.Sig), nameof(newTc.Sig));
