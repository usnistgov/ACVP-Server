...
public class ResultsProjectionContractResolverTests
{
    ...
    public void ShouldSerializeGroupProperties()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(tg.DigestLength, Is.Not.EqualTo(newTg.DigestLength), nameof(newTg.DigestLength));
            Assert.That(tg.CSLength, Is.Not.EqualTo(newTg.CSLength), nameof(newTg.CSLength));
        });
    }
    ...
    public void ShouldSerializeCaseProperties()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(tc.CS, Is.Not.EqualTo(newTc.CS));
            Assert.That(tc.CSBitLength, Is.Not.EqualTo(newTc.CSBitLength));
            Assert.That(tc.Digest, Is.EqualTo(newTc.Digest));
            Assert.That(tc.DigestBitLength, Is.Not.EqualTo(newTc.DigestBitLength));
        });
