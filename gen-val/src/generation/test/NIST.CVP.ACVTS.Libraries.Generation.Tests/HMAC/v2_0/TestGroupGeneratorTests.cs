...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.HMAC.v2_0
{
    ...
    public class TestGroupGeneratorTests
    {
        ...
        public async Task ShouldReturnOneITestGroup(string label, MathDomain keyLen, MathDomain macLen, int expectedResultCount)
        {
            ...
            Assert.That(result, Has.Count.EqualTo(1)); // Updated to always return only one test group
        }
    }
}
