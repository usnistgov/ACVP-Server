...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.SHA3.v1_0.ContractResolvers
{
    ...
    public class ResultsProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeGroupProperties()
        {
            ...
            Assert.That(newTg.BitOrientedInput, Is.Not.EqualTo(tg.BitOrientedInput), nameof(newTg.BitOrientedInput));
            Assert.That(newTg.DigestSize, Is.Not.EqualTo(tg.DigestSize), nameof(newTg.DigestSize));
            Assert.That(newTg.BitOrientedOutput, Is.Not.EqualTo(tg.BitOrientedOutput), nameof(newTg.BitOrientedOutput));
            Assert.That(newTg.IncludeNull, Is.Not.EqualTo(tg.IncludeNull), nameof(newTg.IncludeNull));
        }
        ...
        [Test]
        [TestCase(ModeValues.SHA3, "aft")]
        [TestCase(ModeValues.SHA3, "mct")]
        public void ShouldSerializeSha3CaseProperties(ModeValues function, string testType)
        {
        ...
        /// <param name="testType">The testType</param>
        [Test]
        [TestCase(ModeValues.SHAKE, "aft")]
        [TestCase(ModeValues.SHAKE, "mct")]
        public void ShouldSerializeShakeCaseProperties(ModeValues function, string testType)
        {
            var tvs = TestDataMother.GetTestGroups(1, function, testType);
            var tg = tvs.TestGroups[0];
            var tc = tg.Tests[0];
