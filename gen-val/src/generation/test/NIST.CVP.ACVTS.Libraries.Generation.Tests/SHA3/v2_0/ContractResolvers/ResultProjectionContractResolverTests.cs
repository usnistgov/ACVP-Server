...
namespace NIST.CVP.ACVTS.Libraries.Generation.Tests.SHA3.v2_0.ContractResolvers
{
    ...
    public class ResultsProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeGroupProperties()
        {
            ...
            Assert.That(newTg.HashFunction, Is.Not.EqualTo(tg.HashFunction), nameof(newTg.HashFunction));
            Assert.That(newTg.LargeDataSizes, Is.Not.EqualTo(tg.LargeDataSizes), nameof(newTg.LargeDataSizes));
        }
        ...
        [TestCase("mct")]
        [TestCase("ldt")]
        public void ShouldSerializeSha3CaseProperties(string testType)
        {
