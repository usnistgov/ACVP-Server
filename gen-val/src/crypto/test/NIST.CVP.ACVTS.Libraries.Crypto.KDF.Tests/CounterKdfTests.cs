...
namespace NIST.CVP.ACVTS.Libraries.Crypto.KDF.Tests
{
    ...
    public class CounterKdfTests
    {
        ...
        [TestCase(MacModes.HMAC_SHA256, CounterLocations.BeforeFixedData, 32, 64,
            "09C1281872FE8223E6B3287BA8BD193F5BA7F1C14C0445E92B25D99A7161B2AD",
            "4B4C544D49494400494944204C544D00434F4E5445585400",
            "07961F0426F8A4AB",
            0,
            TestName = "Counter KDF - HMAC_SHA256 - before fixed data - 32 bit counter UL vectors")]
        ...
        [TestCase("Counter KDF - HMAC_SHA256 - before fixed data - 32 bit counter UL vectors",
            MacModes.HMAC_SHA256, CounterLocations.BeforeFixedData, 32, 64,
            "09C1281872FE8223E6B3287BA8BD193F5BA7F1C14C0445E92B25D99A7161B2AD",
            "4B4C544D49494400494944204C544D00434F4E5445585400",
            "07961F0426F8A4AB",
            0)]
