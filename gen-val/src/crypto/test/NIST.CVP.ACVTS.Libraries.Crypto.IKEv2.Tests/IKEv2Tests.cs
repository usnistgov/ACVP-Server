...
namespace NIST.CVP.ACVTS.Libraries.Crypto.IKEv2.Tests
{
    ...
    {
        [Test]
        [TestCase(ModeValues.SHA2, DigestSizes.d224, 1056, 1056,
        ...
        [TestCase(ModeValues.SHA2, DigestSizes.d256, 3072, 3072,
        ...
        public void ShouldIkeV2Correctly(ModeValues mode, DigestSizes digestSize, int dkmLength, int dkmChildLength, string niHex, string nrHex, string girHex, string girNewHex, string spiiHex, string spirHex, string sKeySeedHex, string dkmHex, string dkmChildSAHex, string dkmChildSADhHex, string SKeySeedReKeyHex)
        {
