...
public class MLKEMParameters
{
    ...
    public MLKEMParameters(MLKEMParameterSet param)
    {
        ParameterSet = param;

        switch (param)
        {
            case MLKEMParameterSet.ML_KEM_512:
                N = 256;
                Q = 3329;
                K = 2;
                Eta1 = 3;
            ...
            case MLKEMParameterSet.ML_KEM_768:
                N = 256;
                Q = 3329;
                K = 3;
                Eta1 = 2;
            ...
            case MLKEMParameterSet.ML_KEM_1024:
                N = 256;
                Q = 3329;
                K = 4;
                Eta1 = 2;
            ...
            default:
                throw new ArgumentException($"Invalid {nameof(MLKEMParameterSet)} provided");
        }
    }
}
