...
public class ForsPrfAdrs: AdrsBase, IAdrs
{
    /// <summary>
    /// The FORS_PRF address type defined in section 4.2 of FIPS 205 
    /// </summary>
    ...
    public ForsPrfAdrs()
    {
        AdrsType = AdrsTypes.FORS_PRF;
    }
    
    public ForsPrfAdrs(byte[] treeAddress)
    {
