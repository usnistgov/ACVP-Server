...
public class WotsHashAdrs: AdrsBase, IAdrs
{
    /// <summary>
    /// The WOTS_HASH address type defined in section 4.2 of FIPS 205 
    /// </summary>
    ...
    public WotsHashAdrs()
    {
        AdrsType = AdrsTypes.WOTS_HASH;
    }
    
    public WotsHashAdrs(byte[] layerAddress, byte[] treeAddress)
    {
