...
{
    public class NativeFastSha2_224 : NativeFastSha2SmallBlockBase, ISha
    {
        public HashFunction HashFunction { get; } = new HashFunction(ModeValues.SHA2, DigestSizes.d224);
