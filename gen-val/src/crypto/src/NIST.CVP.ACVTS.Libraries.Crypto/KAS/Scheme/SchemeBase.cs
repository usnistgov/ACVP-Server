...
namespace NIST.CVP.ACVTS.Libraries.Crypto.KAS.Scheme
{
        ...
        where TKeyPair : IDsaKeyPair
    {
        ...
        public KasResult ComputeResult(TOtherPartySharedInfo otherPartyInformation)
        {
            ...
            var kdf = KdfFactory.GetInstance(kdfConfiguration, true);
