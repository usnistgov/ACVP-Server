...
namespace NIST.CVP.ACVTS.Libraries.Orleans.Grains.Kas.Sp800_56Ar3.Helpers
{
    public static class KeyingMaterialHelpers
    {
            ...
            BitString partyId)
        {
            ...
            {
                builder.WithEphemeralNonce(
                    entropyProvider.GetEntropy(curveAttributes.DegreeOfPolynomial.ValueToMod(BitString.BITSINBYTE)));
            }
