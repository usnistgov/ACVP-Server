...
{
    public class ObserverKdaAftHkdfCaseGrain : ObservableOracleGrainBase<KdaAftHkdfResult>, IObserverKdaAftHkdfCaseGrain
    {
        ...
        private KdaAftHkdfParameters _param;


        public ObserverKdaAftHkdfCaseGrain(
        ...
        public async Task<bool> BeginWorkAsync(KdaAftHkdfParameters param)
        {
            _param = param;
