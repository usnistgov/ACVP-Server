...
{
    public class ObserverKdaValHkdfCaseGrain : ObservableOracleGrainBase<KdaValHkdfResult>, IObserverKdaValHkdfCaseGrain
    {
        ...
        private KdaValHkdfParameters _param;


        public ObserverKdaValHkdfCaseGrain(
        ...
        public async Task<bool> BeginWorkAsync(KdaValHkdfParameters param)
        {
            _param = param;
        ...
        private async Task Kdf()
        {
            ...
            while (true)
            {
                ...
                await Notify(new KdaValHkdfResult()
                {
