...
{
    public class ObserverKdaValOneStepNoCounterCaseGrain : ObservableOracleGrainBase<KdaValOneStepNoCounterResult>, IObserverKdaValOneStepNoCounterCaseGrain
    {
        ...
        private KdaValOneStepNoCounterParameters _param;


        public ObserverKdaValOneStepNoCounterCaseGrain(
        ...
        public async Task<bool> BeginWorkAsync(KdaValOneStepNoCounterParameters param)
        {
            _param = param;
        ...
        protected override async Task DoWorkAsync()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    await Notify(new KdaValOneStepNoCounterResult()
                    {
