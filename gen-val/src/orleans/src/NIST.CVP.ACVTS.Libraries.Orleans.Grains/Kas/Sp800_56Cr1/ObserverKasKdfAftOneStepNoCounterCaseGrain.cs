...
{
    public class ObserverKdaAftOneStepNoCounterCaseGrain : ObservableOracleGrainBase<KdaAftOneStepNoCounterResult>, IObserverKdaAftOneStepNoCounterCaseGrain
    {
        ...
        private KdaAftOneStepNoCounterParameters _param;


        public ObserverKdaAftOneStepNoCounterCaseGrain(
        ...
        public async Task<bool> BeginWorkAsync(KdaAftOneStepNoCounterParameters param)
        {
            _param = param;
        ...
        protected override async Task DoWorkAsync()
        {
            try
            {
                ...
                await Notify(new KdaAftOneStepNoCounterResult()
                {
                    KdfInputs = (KdfParameterOneStepNoCounter)kdfParam,
