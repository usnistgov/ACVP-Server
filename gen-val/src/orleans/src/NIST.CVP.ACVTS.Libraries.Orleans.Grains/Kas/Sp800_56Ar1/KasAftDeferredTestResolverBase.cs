...
namespace NIST.CVP.ACVTS.Libraries.Orleans.Grains.Kas.Sp800_56Ar1
{
        ...
        where TScheme : struct, IComparable
    {
        ...
        public TKasAftDeferredResult CompleteTest(TKasAftDeferredParameters param)
        {
            ...
            var entropyProvider = new TestableEntropyProvider(false);
        ...
        /// <returns></returns>
        protected abstract SchemeKeyNonceGenRequirement GetServerNonceKeyGenRequirements(
        ...
        > GetServerKas(
            SchemeKeyNonceGenRequirement serverKeyRequirements,
