...
public interface IOracleObserverMLKEMDecapCaseGrain : IGrainWithGuidKey, IGrainObservable<MLKEMEncapsulationResult>
{
    Task<bool> BeginWorkAsync(MLKEMDecapsulationParameters param);
}
