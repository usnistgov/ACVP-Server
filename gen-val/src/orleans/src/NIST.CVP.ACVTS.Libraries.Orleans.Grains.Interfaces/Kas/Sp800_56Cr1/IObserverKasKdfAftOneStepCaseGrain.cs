...
{
    public interface IObserverKdaAftOneStepCaseGrain : IGrainWithGuidKey, IGrainObservable<KdaAftOneStepResult>
    {
        Task<bool> BeginWorkAsync(KdaAftOneStepParameters param);
    }
}
