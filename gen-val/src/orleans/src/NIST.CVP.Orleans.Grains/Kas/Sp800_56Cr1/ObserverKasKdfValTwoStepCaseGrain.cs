...
{
	public class ObserverKasKdfValTwoStepCaseGrain : ObservableOracleGrainBase<KasKdfValTwoStepResult>, IObserverKasKdfValTwoStepCaseGrain
	{
		...
		private KasKdfValTwoStepParameters _param;
		

		public ObserverKasKdfValTwoStepCaseGrain(
		...
		public async Task<bool> BeginWorkAsync(KasKdfValTwoStepParameters param)
		{
			_param = param;
		...
		protected override async Task DoWorkAsync()
		{
			try
			{
				...
				while (true)
				{
					...
					await Notify(new KasKdfValTwoStepResult()
					{
