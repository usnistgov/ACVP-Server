...
namespace NIST.CVP.Orleans.Grains.Kas.Sp800_56Cr1
{
	public class ObserverKasKdfValOneStepCaseGrain : ObservableOracleGrainBase<KasKdfValOneStepResult>, IObserverKasKdfValOneStepCaseGrain
	{
		...
		private KasKdfValOneStepParameters _param;
		

		public ObserverKasKdfValOneStepCaseGrain(
		...
		public async Task<bool> BeginWorkAsync(KasKdfValOneStepParameters param)
		{
			_param = param;
		...
		protected override async Task DoWorkAsync()
		{
			try
			{
				...
				while (true)
				{
					...
					await Notify(new KasKdfValOneStepResult()
					{
