...
{
	public interface IObserverKasKdfAftHkdfCaseGrain : IGrainWithGuidKey, IGrainObservable<KasKdfAftHkdfResult>
	{
		Task<bool> BeginWorkAsync(KasKdfAftHkdfParameters param);
	}
}