...
{
	public interface IObserverKasKdfValOneStepCaseGrain : IGrainWithGuidKey, IGrainObservable<KasKdfValOneStepResult>
	{
		Task<bool> BeginWorkAsync(KasKdfValOneStepParameters param);
	}
}