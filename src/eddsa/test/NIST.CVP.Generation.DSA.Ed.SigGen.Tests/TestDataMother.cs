        ...
        public static TestVectorSet GetTestGroups(int groups = 1, bool isSample = true)
        {
            ...
            for (var groupIdx = 0; groupIdx < groups; groupIdx++)
            {
                var tg = new TestGroup
                {
                    Curve = Curve.Ed25519,
                    PreHash = false,
                    KeyPair = new EdKeyPair(new BitString("ec172b93ad5e563bf4932c70e1245034c35467ef2efd4d64ebf819683467e2bf"), 14)
                };
                testGroups.Add(tg);

                if (!isSample)
                {
                    tg.KeyPair = new EdKeyPair(new BitString("3d4017c3e843895a92b70aa74d1b7ebc9c982ccf2ec4968cc0cd55f12af4660c"), 14);
                }
