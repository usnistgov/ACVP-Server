...
namespace NIST.CVP.Generation.TDES_OFBI.Tests
{
    ...
    public class TestVectorSetTests
    {
        ...
        public void DecryptShouldIncludeCipherTextInPromptProjection()
        {
            ...
            foreach (var test in tests)
            {
                Assert.IsTrue(!string.IsNullOrEmpty(test.cipherTextt.ToString()));
            }
        }
        ...
        public void DecryptShouldIncludePlainTextInResultProjectionWhenNotFailureTest()
        {
            ...
            foreach (var item in results)
            {
                Assert.IsTrue(!string.IsNullOrEmpty(item.plainTextt.ToString()));
            }
        }
        ...
        {
            var subject = new TestVectorSet { Algorithm = "TDES-OFBI" };
