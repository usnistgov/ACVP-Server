...
namespace NIST.CVP.Crypto.AES_CFB128.Tests
{
    ...
    public class AES_CFB128_MCTTests
    {
        private Mock<IAES_CFB128> _aes;
        private AES_CFB128_MCT _subject;

        [SetUp]
        public void Setup()
        {
            _aes = new Mock<IAES_CFB128>();
            _subject = new AES_CFB128_MCT(_aes.Object);
        }
