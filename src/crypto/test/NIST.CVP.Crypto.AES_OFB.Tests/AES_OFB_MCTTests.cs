...
namespace NIST.CVP.Crypto.AES_OFB.Tests
{
    ...
    public class AES_OFB_MCTTests
    {
        ...
        private AES_OFB_MCT _subject;

        [SetUp]
        public void Setup()
        {
            _aesOfb = new Mock<IAES_OFB>();
            _subject = new AES_OFB_MCT(_aesOfb.Object);
        }
        ...
        public void ShouldRunEncryptOperation100000TimesForTestCase(int keySize)
        {
            ...
            _aesOfb.Verify(v => v.BlockEncrypt(It.IsAny<BitString>(), It.IsAny<BitString>(), It.IsAny<BitString>()), Times.Exactly(100000), nameof(_aesOfb.Object.BlockEncrypt));
        }
        ...
        public void ShouldRunDecryptOperation100000TimesForTestCase(int keySize)
        {
            ...
            Assert.IsTrue(result.Success, nameof(result.Success));
            _aesOfb.Verify(v => v.BlockDecrypt(It.IsAny<BitString>(), It.IsAny<BitString>(), It.IsAny<BitString>()), Times.Exactly(100000), nameof(_aesOfb.Object.BlockDecrypt));
        }
