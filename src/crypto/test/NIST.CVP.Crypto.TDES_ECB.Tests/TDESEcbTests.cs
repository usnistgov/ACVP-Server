...
namespace NIST.CVP.Crypto.TDES_ECB.Tests
{
    ...
    public class TDESEcbTests
    {
        ...
        private EcbBlockCipher _newSubject;

        [OneTimeSetUp]
        public void Setup()
        {
            var engine = new TdesEngine();
            _newSubject = new EcbBlockCipher(engine);
        }
        ...
        public void ShouldPassInversePermuatationEncryptKnownAnswerTest(string key, string plaintext, string cipherText)
        {
            var subject = new TDES_ECB();
        ...
        public void ShouldPassPermuatationEncryptKnownAnswerTest(string key, string plaintext, string cipherText)
        {
            var subject = new TDES_ECB();
            var result = subject.BlockEncrypt(new BitString(key), new BitString(plaintext));
            Assert.IsTrue((bool)result.Success);
        ...
        public void ShouldPassSubstitutionTableEncryptKnownAnswerTest(string key, string plaintext, string cipherText)
        {
            var subject = new TDES_ECB();
            var result = subject.BlockEncrypt(new BitString(key), new BitString(plaintext));
            Assert.IsTrue((bool)result.Success);
        ...
        [TestCase("018310dc409b26d6", "1d9d5c5018f728c2", "5f4c038ed12b2e41")]
        [TestCase("1c587f1c13924fef", "305532286d6f295a", "63fac0d034d9f793")]
        public void ShouldPassSubstitutionTableDecryptKnownAnswerTest(string key, string plaintext, string cipherText)
        {
            var subject = new TDES_ECB();
            var result = subject.BlockDecrypt(new BitString(key), new BitString(cipherText));
            Assert.IsTrue((bool)result.Success);
        ...
        [Test]
        public void ShouldPassStartupTestNewEngine()
        {
            var keyBytes = new byte[] { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef };
            var plainTextBytes = new byte[] { 0x4e, 0x6f, 0x77, 0x20, 0x69, 0x73, 0x20, 0x74 };
            var expectedBytes = new byte[] { 0x3f, 0xa4, 0x0e, 0x8a, 0x98, 0x4d, 0x48, 0x15 };
        ...
        [TestCase("0101010101010101", "06e7ea22ce92708f", "0000000000000002")]
        [TestCase("0101010101010101", "166b40b44aba4bd6", "0000000000000001")]
        public void ShouldPassInversePermuatationEncryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
                new BitString(key),
        ...
        [TestCase("1002911598100201", "0000000000000000", "e2f5728f0995013c")]
        [TestCase("1002911698100101", "0000000000000000", "1aeac39a61f0a464")]
        public void ShouldPassPermuatationEncryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
                new BitString(key),
        ...
        [TestCase("018310dc409b26d6", "1d9d5c5018f728c2", "5f4c038ed12b2e41")]
        [TestCase("1c587f1c13924fef", "305532286d6f295a", "63fac0d034d9f793")]
        public void ShouldPassSubstitutionTableEncryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
                new BitString(key),
        ...
        [TestCase("0101010101010104", "fcdb3291de21f0c0")]
        [TestCase("0101010101010102", "869efd7f9f265a09")]
        public void ShouldPassVariableKeyEncryptKnownAnswerTestNewEngine(string key, string cipherText)
        {
            string plaintext = "0000000000000000";
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
        ...
        [TestCase("0000000000000002", "06e7ea22ce92708f")]
        [TestCase("0000000000000001", "166b40b44aba4bd6")]
        public void ShouldPassVariablePlainTextEncryptKnownAnswerTestNewEngine(string plaintext, string cipherText)
        {
            string key = "0101010101010101";
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
        ...
        [TestCase("198f973b5462df64946245e0b6ec0d98a4e5136ba75294b3", "60dd7b8f00554bb6003161ba62fd66adc2757a40dbf5d6d84d30b0e49e255f6d7e4fc0ee4f1cd867e4a1bbad898cac04445a85ef5bca5a471691598bc64ff47706c243d84139a39a", "b141cecac08330b54c182e9115881265693cd5a84e505c903dd81757fc351dfcc6ecdd23672d24761c7cb05978abc45dd4a5dc34ae11d65eaa02606aac3bffc76f5d6c4a7d5d17b0")]
        [TestCase("c1da626de38389f11cc28fe0f8fdb623374ccb495d20c81f", "5fe074a3c30b281ec7db62b76ddbcb7d51c784242ffbc410a42ac2b03953d50d9df1d9a33273d66fcbebdc49b50a3174f44caf74ce70671f8e2b8af7821d8ab746047c2c4430c1467c37e56f81e9c71c", "d7f5edf35f207dfcdae580d4d903a3c289da22a9ec1c0e06ffd333f47773d3193570cc048571b923d21a1871eb228f4155455535da42e71289764000356acf089605a5f57aba25533bda531db14f6553")]
        public void ShouldFailMultiBlockEncryptTestsNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Encrypt,
                new BitString(key),
        ...
        [TestCase("1002911598100201", "0000000000000000", "e2f5728f0995013c")]
        [TestCase("1002911698100101", "0000000000000000", "1aeac39a61f0a464")]
        public void ShouldPassPermuatationDecryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
        ...
        [TestCase("0101010101010101", "06e7ea22ce92708f", "0000000000000002")]
        [TestCase("0101010101010101", "166b40b44aba4bd6", "0000000000000001")]
        public void ShouldPassInversePermuatationDecryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Decrypt,
                new BitString(key),
        ...
        [TestCase("018310dc409b26d6", "1d9d5c5018f728c2", "5f4c038ed12b2e41")]
        [TestCase("1c587f1c13924fef", "305532286d6f295a", "63fac0d034d9f793")]
        public void ShouldPassSubstitutionTableDecryptKnownAnswerTestNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Decrypt,
                new BitString(key),
        ...
        [TestCase("0101010101010104", "fcdb3291de21f0c0")]
        [TestCase("0101010101010102", "869efd7f9f265a09")]
        public void ShouldPassVariableKeyDecryptKnownAnswerTestNewEngine(string key, string cipherText)
        {
            string plaintext = "0000000000000000";
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Decrypt,
        ...
        [TestCase("0000000000000002", "06e7ea22ce92708f")]
        [TestCase("0000000000000001", "166b40b44aba4bd6")]
        public void ShouldPassVariablePlainTextDecryptKnownAnswerTestNewEngine(string plaintext, string cipherText)
        {
            string key = "0101010101010101";
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Decrypt,
        ...
        [TestCase("198f973b5462df64946245e0b6ec0d98a4e5136ba75294b3", "60dd7b8f00554bb6003161ba62fd66adc2757a40dbf5d6d84d30b0e49e255f6d7e4fc0ee4f1cd867e4a1bbad898cac04445a85ef5bca5a471691598bc64ff47706c243d84139a39a", "b141cecac08330b54c182e9115881265693cd5a84e505c903dd81757fc351dfcc6ecdd23672d24761c7cb05978abc45dd4a5dc34ae11d65eaa02606aac3bffc76f5d6c4a7d5d17b0")]
        [TestCase("c1da626de38389f11cc28fe0f8fdb623374ccb495d20c81f", "5fe074a3c30b281ec7db62b76ddbcb7d51c784242ffbc410a42ac2b03953d50d9df1d9a33273d66fcbebdc49b50a3174f44caf74ce70671f8e2b8af7821d8ab746047c2c4430c1467c37e56f81e9c71c", "d7f5edf35f207dfcdae580d4d903a3c289da22a9ec1c0e06ffd333f47773d3193570cc048571b923d21a1871eb228f4155455535da42e71289764000356acf089605a5f57aba25533bda531db14f6553")]
        public void ShouldFailMultiBlockDecryptTestsNewEngine(string key, string plaintext, string cipherText)
        {
            var param = new ModeBlockCipherParameters(
                BlockCipherDirections.Decrypt,
                new BitString(key),
