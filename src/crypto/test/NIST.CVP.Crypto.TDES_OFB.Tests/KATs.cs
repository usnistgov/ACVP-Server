...
namespace NIST.CVP.Crypto.TDES_OFB.Tests
{
    ...
    public class KATs
    {
        ...
        [TestCase("0101010101010101", "06e7ea22ce92708f", "0000000000000002")]
        [TestCase("0101010101010101", "166b40b44aba4bd6", "0000000000000001")]
        public void ShouldPassInversePermuatationEncryptKnownAnswerTestNewEngine(string key, string iv, string cipherText)
        {
            var plaintext = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("1002911598100201", "0000000000000000", "e2f5728f0995013c")]
        [TestCase("1002911698100101", "0000000000000000", "1aeac39a61f0a464")]
        public void ShouldPassPermuatationEncryptKnownAnswerTestNewEngine(string key, string iv, string cipherText)
        {
            var plaintext = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("018310dc409b26d6", "1d9d5c5018f728c2", "5f4c038ed12b2e41")]
        [TestCase("1c587f1c13924fef", "305532286d6f295a", "63fac0d034d9f793")]
        public void ShouldPassSubstitutionTableEncryptKnownAnswerTestNewEngine(string key, string iv, string cipherText)
        {
            var plaintext = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("0000000000000002", "06e7ea22ce92708f")]
        [TestCase("0000000000000001", "166b40b44aba4bd6")]
        public void ShouldPassVariablePlainTextEncryptKnownAnswerTestNewEngine(string iv, string cipherText)
        {
            string key = "0101010101010101";
            var plaintext = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("0101010101010101", "06e7ea22ce92708f", "0000000000000002")]
        [TestCase("0101010101010101", "166b40b44aba4bd6", "0000000000000001")]
        public void ShouldPassInversePermuatationDecryptKnownAnswerTestNewEngine(string key, string plaintext, string iv)
        {
            var cipherText = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("018310dc409b26d6", "1d9d5c5018f728c2", "5f4c038ed12b2e41")]
        [TestCase("1c587f1c13924fef", "305532286d6f295a", "63fac0d034d9f793")]
        public void ShouldPassSubstitutionTableDecryptKnownAnswerTestNewEngine(string key, string iv, string cipherText)
        {
            var plaintext = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        [TestCase("0000000000000002", "06e7ea22ce92708f")]
        [TestCase("0000000000000001", "166b40b44aba4bd6")]
        public void ShouldPassVariablePlainTextDecryptKnownAnswerTestNewEngine(string plaintext, string iv)
        {
            string key = "0101010101010101";
            var cipherText = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
