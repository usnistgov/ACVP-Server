...
namespace NIST.CVP.Generation.DRBG.Tests
{
    ...
    public class TestCaseGeneratorNoReseedTests
    {
        private TestCaseGeneratorNoReseed _subject;
        ...
        public void Setup()
        {
            ...
            _subject = new TestCaseGeneratorNoReseed(_entropyProviderFactory.Object, _drbgFactory.Object);
        }

        /// <summary>
        /// For NoReseed, two generates are run w/o a reseed.  
        /// OtherInput should have two objects within it to convey this.
        /// </summary>
        [Test]
        public void ShouldContainTwoCountInOtherInput()
        {
            var vectorSet = DRBG.TestDataMother.GetSampleVectorSet(1, 1, false, false);
        ...
        {
            var vectorSet = DRBG.TestDataMother.GetSampleVectorSet(1, 1, false, predictionResistance);
