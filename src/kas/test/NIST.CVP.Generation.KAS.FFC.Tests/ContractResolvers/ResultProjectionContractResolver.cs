...
using NIST.CVP.Generation.KAS.v1_0.FFC.ContractResolvers;
using NIST.CVP.Tests.Core.TestCategoryAttributes;
using NUnit.Framework;

namespace NIST.CVP.Generation.KAS.FFC.Tests.ContractResolvers
{
    ...
    public class ResultsProjectionContractResolverTests
    {
        ...
        public void ShouldSerializeGroupProperties(string testType, KasMode kasMode, KeyAgreementMacType macType, KeyConfirmationRole kcRole, KeyConfirmationDirection kcType)
        {
            ...
            Assert.IsFalse(json.ToLower().Contains(nameof(TestGroup.KasRole).ToLower()), nameof(TestGroup.KasRole));
