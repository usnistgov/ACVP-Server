...
namespace NIST.CVP.Generation.ParallelHash.IntegrationTests
{
    ...
    public class VOTTests
    {
        ...
        public void ShouldGenerateParallelHashVOTWithProperSizes(int min, int max, bool bitOriented)
        {
            var subject = new TestCaseGeneratorVOTHash(new Random800_90(), new Crypto.ParallelHash.ParallelHash());
            var prevCase = 0;
