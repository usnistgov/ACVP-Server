...
namespace NIST.CVP.Generation.ParallelHash.Tests
{
    ...
    public class TestGroupGeneratorLargeCustomizationTests
    {
        ...
        public void ShouldCreateTestGroupForEachCombinationOfModeAndDigestSize(int expectedGroupsCreated, Parameters parameters)
        {
            var subject = new TestGroupGeneratorLargeCustomization();
