...
namespace NIST.CVP.Generation.DSA.FFC.PQGGen.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            return new ParseResponse<TestVectorSet>(new TestVectorSet { Algorithm = "DSA", Mode = "PQGGen", TestGroups = groups.Select(g => (ITestGroup)g).ToList() });
        }
    }
}
