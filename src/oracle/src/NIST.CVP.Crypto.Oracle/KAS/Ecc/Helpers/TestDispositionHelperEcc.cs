...
namespace NIST.CVP.Crypto.Oracle.KAS.Ecc.Helpers
{
    public static class TestDispositionHelperEcc
    {
        ...
        internal static void SetAftResultInformationFromKasProcessing(KasAftParametersEcc param, KasAftResultEcc result, IKas<KasDsaAlgoAttributesEcc, OtherPartySharedInformation<EccDomainParameters, EccKeyPair>, EccDomainParameters, EccKeyPair> serverKas, IKas<KasDsaAlgoAttributesEcc, OtherPartySharedInformation<EccDomainParameters, EccKeyPair>, EccDomainParameters, EccKeyPair> iutKas, KasResult iutResult)
        {
