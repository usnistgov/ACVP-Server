...
namespace NIST.CVP.Crypto.Core.Tests
{
    ...
    {
        [Test]
        [TestCase(AlgoMode.TDES_CFB1_v1_0, "ACVP-TDES-CFB1-1.0")]
        [TestCase(AlgoMode.TDES_CFB8_v1_0, "ACVP-TDES-CFB8-1.0")]
        [TestCase(AlgoMode.TDES_CFB64_v1_0, "ACVP-TDES-CFB64-1.0")]
