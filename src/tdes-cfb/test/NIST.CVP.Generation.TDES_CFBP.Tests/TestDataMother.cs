            ...
            for (var groupIdx = 0; groupIdx < groups; groupIdx++)
            {
                ...
                for (var testId = 15 * groupIdx + 1; testId <= (groupIdx + 1) * 15; testId++)
                {
                    var tc = new TestCase
                    {
                        ...
                        PlainText1 = new BitString("1AAADFFF"),
                        PlainText2 = new BitString("1AAADFFF"),
                        PlainText3 = new BitString("1AAADFFF"),
                        Deferred = true,
                        CipherText = new BitString("7EADDC"),
                        CipherText1 = new BitString("7EADDC"),
                        CipherText2 = new BitString("7EADDC"),
                        CipherText3 = new BitString("7EADDC"),
