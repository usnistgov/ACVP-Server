...
using NIST.CVP.Generation.TDES_CFB.Async;
using NIST.CVP.Generation.TDES_CFB.ContractResolvers;
using NIST.CVP.Math;

namespace NIST.CVP.Generation.TDES_CFB
{
    public class RegisterInjectionsAsync : IRegisterInjections
    {
        public void RegisterTypes(ContainerBuilder builder, AlgoMode algoMode)
        {
            ...
            builder.RegisterType<TestCaseGeneratorFactoryAsync>().AsImplementedInterfaces();
            builder.RegisterType<Core.Async.TestCaseGeneratorFactoryFactory<TestVectorSet, TestGroup, TestCase>>().AsImplementedInterfaces();
