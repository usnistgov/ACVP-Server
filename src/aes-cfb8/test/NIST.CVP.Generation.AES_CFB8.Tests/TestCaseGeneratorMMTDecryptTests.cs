...
namespace NIST.CVP.Generation.AES_CFB8.Tests
{
    ...
    public class TestCaseGeneratorMMTDecryptTests
    {
        ...
        public void GeneratedPlainTextShouldEncryptBackToCipherText()
        {
            ...
            var aes_cfb8 = new Crypto.AES_CFB8.AES_CFB8(rf);
            var subject = new TestCaseGeneratorMMTDecrypt(new Random800_90(), aes_cfb8);
            ...
            {
                var encryptResult = aes_cfb8.BlockEncrypt(testCase.IV, testCase.Key, testCase.PlainText);
        ...
        private Mock<IAES_CFB8> GetAESMock()
        {
            return new Mock<IAES_CFB8>();
        }
    }
}
