...
namespace NIST.CVP.Generation.AES_CTR.Tests
{
    ...
    public class TestCaseGeneratorPartialBlockDecryptTests
    {
        [Test]
        public void GenerateShouldReturnTestCaseGenerateResponse()
        {
            var subject = new TestCaseGeneratorPartialBlockDecrypt(GetRandomMock().Object, GetAESMock().Object);
        ...
        public void GenerateShouldReturnNullITestCaseOnFailedEncryption()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(GetRandomMock().Object, aes.Object);
        ...
        public void GenerateShouldInvokeEncryptionOperation()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(random.Object, aes.Object);

            var result = subject.Generate(GetTestGroup(), true);

            aes.Verify(v => v.DecryptBlock(It.IsAny<BitString>(), It.IsAny<BitString>(), It.IsAny<BitString>()),
                Times.AtLeastOnce,
        ...
        public void GeneratedCipherTextShouldDecryptBackToPlainText()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(new Random800_90(), aes_ctr);
