...
namespace NIST.CVP.Generation.AES_CTR.Tests
{
    ...
    public class TestCaseGeneratorSingleBlockEncryptTests
    {
        ...
        {
            var subject = new TestCaseGeneratorSingleBlockEncrypt(GetRandomMock().Object, GetAESMock().Object);
        ...
        public void GenerateShouldReturnNullITestCaseOnFailedEncryption()
        {
            ...
            var subject = new TestCaseGeneratorSingleBlockEncrypt(GetRandomMock().Object, aes.Object);
        ...
        public void GenerateShouldInvokeEncryptionOperation()
        {
            ...
            var subject = new TestCaseGeneratorSingleBlockEncrypt(random.Object, aes.Object);
        ...
        public void GeneratedCipherTextShouldDecryptBackToPlainText()
        {
            ...
            var subject = new TestCaseGeneratorSingleBlockEncrypt(new Random800_90(), aes_ctr);
