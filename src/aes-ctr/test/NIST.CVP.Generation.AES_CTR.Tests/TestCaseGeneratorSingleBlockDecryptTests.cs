...
namespace NIST.CVP.Generation.AES_CTR.Tests
{
    ...
    public class TestCaseGeneratorSingleBlockDecryptTests
    {
        ...
        {
            var subject = new TestCaseGeneratorSingleBlockDecrypt(GetRandomMock().Object, GetAESMock().Object);
        ...
        public void GeneratedCipherTextShouldDecryptBackToPlainText()
        {
            ...
            var subject = new TestCaseGeneratorSingleBlockDecrypt(new Random800_90(), aes_ctr);
