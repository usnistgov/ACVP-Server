...
namespace NIST.CVP.Generation.KeyWrap.AES
{
    public class TestCaseGeneratorFactory : ITestCaseGeneratorFactory<TestGroup, TestCase>
    {
        ...
        public ITestCaseGenerator<TestGroup, TestCase> GetCaseGenerator(TestGroup testGroup)
        {
            ...
            {
                case "encrypt":
                    return new TestCaseGeneratorEncrypt<TestGroup, TestCase>(_iKeyWrapFactory, _iRandom800_90);
                case "decrypt":
                    return new TestCaseGeneratorDecrypt<TestGroup, TestCase>(_iKeyWrapFactory, _iRandom800_90);
                default:
