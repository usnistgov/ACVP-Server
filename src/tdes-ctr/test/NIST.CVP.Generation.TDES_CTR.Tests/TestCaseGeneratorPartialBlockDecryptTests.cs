...
namespace NIST.CVP.Generation.TDES_CTR.Tests
{
    ...
    public class TestCaseGeneratorPartialBlockDecryptTests
    {
        ...
        {
            var subject = new TestCaseGeneratorPartialBlockDecrypt(GetRandomMock().Object, GetTDESMock().Object);
        ...
        public void GenerateShouldReturnNullITestCaseOnFailedEncryption()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(GetRandomMock().Object, tdes.Object);
        ...
        public void GenerateShouldInvokeEncryptionOperation()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(random.Object, tdes.Object);
        ...
        public void GeneratedCipherTextShouldDecryptBackToPlainText()
        {
            ...
            var subject = new TestCaseGeneratorPartialBlockDecrypt(new Random800_90(), tdes_ctr);
