...
using NIST.CVP.Generation.AES_CFB128.Parsers;
...
namespace NIST.CVP.Generation.AES_CFB128.IntegrationTests
{
    ...
    public class FireHoseTests
    {
        ...
        private Crypto.AES_CFB128.AES_CFB128 _algo;
        private AES_CFB128_MCT _algoMct;
        
        [SetUp]
        public void Setup()
        {
            _testPath = Utilities.GetConsistentTestingStartPath(GetType(), @"..\..\TestFiles\LegacyParserFiles\");
            _algo = new Crypto.AES_CFB128.AES_CFB128(new RijndaelFactory(new RijndaelInternals()));
            _algoMct = new AES_CFB128_MCT(_algo);
        }
