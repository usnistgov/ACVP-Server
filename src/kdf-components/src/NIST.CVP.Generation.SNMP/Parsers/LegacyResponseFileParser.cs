...
namespace NIST.CVP.Generation.SNMP.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            var testVectorSet = new TestVectorSet { Algorithm = "kdf-components", Mode = "snmp", TestGroups = groups.Select(g => (ITestGroup)g).ToList() };
