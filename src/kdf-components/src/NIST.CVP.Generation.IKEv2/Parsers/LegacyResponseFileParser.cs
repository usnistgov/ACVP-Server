...
namespace NIST.CVP.Generation.IKEv2.Parsers
{
    public class LegacyResponseFileParser : ILegacyResponseFileParser<TestVectorSet>
    {
        public ParseResponse<TestVectorSet> Parse(string path)
        {
            ...
            var testVectorSet = new TestVectorSet { Algorithm = "kdf-components", Mode = "ikev2", TestGroups = groups.Select(g => (ITestGroup)g).ToList() };
