...
namespace NIST.CVP.Generation.TDES_ECB.IntegrationTests
{
    ...
    public class GenValTests
    {
        ...
        public void Setup()
        {
            ...
            TDES_ECB_Val.AutofacConfig.OverrideRegistrations = null;
        }
        ...
        {
            var result = tdes_ecb.Program.Main(new string[] { });
        ...
        {
            var result = tdes_ecb.Program.Main(new string[] { $"{Guid.NewGuid()}.json" });
        ...
        public void GenShouldReturn1OnFailedRun()
        {
            ...
            var result = tdes_ecb.Program.Main(new string[] { fileName });
        ...
        {
            TDES_ECB_Val.AutofacConfig.OverrideRegistrations = builder =>
            {
            ...
            var result = TDES_ECB_Val.Program.Main(
